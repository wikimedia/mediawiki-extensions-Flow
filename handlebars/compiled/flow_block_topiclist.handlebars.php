	...
	'.LCRun3::ch($cx, 'l10nParse', Array('flow-anon-warning',LCRun3::ch($cx, 'linkWithReturnTo', Array('Special:UserLogin'), 'encq'),LCRun3::ch($cx, 'linkWithReturnTo', Array('Special:UserLogin/signup'), 'encq')), 'encq').'';}).'
		...
		<div class="flow-form-actions flow-form-collapsible">
			<button data-role="submit" data-flow-api-handler="newTopic"
				data-flow-interactive-handler="apiRequest"
				class="mw-ui-button mw-ui-constructive">'.LCRun3::ch($cx, 'l10n', Array('flow-newtopic-save'), 'encq').'</button>
        ...
        class="mw-ui-button mw-ui-progressive mw-ui-quiet">'.LCRun3::ch($cx, 'l10n', Array('flow-preview'), 'encq').'</button>
			<button data-flow-interactive-handler="cancelForm" data-role="cancel"
				      class="mw-ui-button mw-ui-quiet mw-ui-destructive">'.LCRun3::ch($cx, 'l10n', Array('flow-cancel'), 'encq').'</button>
		...
		<div class="flow-menu">
			...
			<ul class="mw-ui-button-container">
				...
				'.((LCRun3::ifvar($cx, ((is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null))) ? '
					<li>
						<a class="mw-ui-button flow-ui-regressive mw-ui-progressive  mw-ui-quiet flow-ui-thin"
...
' : '').'
	...
	'.LCRun3::ch($cx, 'l10nParse', Array('flow-anon-warning',LCRun3::ch($cx, 'linkWithReturnTo', Array('Special:UserLogin'), 'encq'),LCRun3::ch($cx, 'linkWithReturnTo', Array('Special:UserLogin/signup'), 'encq')), 'encq').'';}).'
        ...
        class="mw-ui-button mw-ui-progressive mw-ui-quiet">'.LCRun3::ch($cx, 'l10n', Array('flow-preview'), 'encq').'</button>
			<button data-flow-interactive-handler="cancelForm" data-role="cancel"
			        class="mw-ui-button mw-ui-quiet">'.LCRun3::ch($cx, 'l10n', Array('flow-cancel'), 'encq').'</button>
...
';}).'
	...
	<div class="flow-load-more">
		...
		<a data-flow-interactive-handler="apiRequest"
		   ...
		   class="mw-ui-button mw-ui-progressive flow-load-interactive"><span class="wikiglyph wikiglyph-article"></span> '.LCRun3::ch($cx, 'l10n', Array('flow-load-more'), 'encq').'</a>
	</div>
' : '').'
