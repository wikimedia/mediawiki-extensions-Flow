...
interface Postprocessor {
	...
	/**
	 * Called after the page is archived (to make way for the Flow board)
	 *
	 * @param {string} $archiveTitle Destination page that talk page was archived to
	 */
	function afterPageArchived( $archiveTitle );
