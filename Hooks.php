	...
	public static function onResourceLoaderRegisterModules( ResourceLoader &$resourceLoader ) {
		...
		$resourceLoader->register( 'ext.flow.ui', array(
			...
			'dependencies' => array(
				...
				'ext.flow.ui.visualeditor' : 'oojs-ui.styles.icons-editing-advanced'
				/* Duplicated dependacy to allow if and else in array */ ),
			),
		...
		$resourceLoader->register( 'ext.flow', array(
			...
			'dependencies' => array(
				...
				( \ExtensionRegistry::getInstance()->isLoaded( 'VisualEditor' ) ?
				'ext.flow.board.visualeditor' : 'mediawiki.api.options'
				/* Duplicated dependacy to allow if and else in array */ ),
			),
			'messages' => array(
				'flow-error-external',
