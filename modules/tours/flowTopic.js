( function () {
	...
	tour.step( {
		name: 'watch',
		titlemsg: isLoggedIn ? 'flow-guidedtour-topic-watch' : 'flow-guidedtour-topic-watch-ips',
		descriptionmsg: isLoggedIn ? 'flow-guidedtour-topic-watch-description' : 'flow-guidedtour-topic-watch-ips-description',
