...
$messages['en'] = array(
	...
	'flow-moderation-intro-suppress-post' => "Please {{GENDER:$3|explain}} why you're suppressing {{GENDER:$1|this}} post.",
	'flow-moderation-intro-delete-post' => "Please {{GENDER:$3|explain}} why you're deleting {{GENDER:$1|this}} post.",
	'flow-moderation-intro-hide-post' => "Please {{GENDER:$3|explain}} why you're hiding {{GENDER:$1|this}} post.",
	'flow-moderation-intro-restore-post' => "Please {{GENDER:$3|explain}} why you're restoring {{GENDER:$1|this}} post.",
	...
	'flow-moderation-intro-suppress-topic' => "Please {{GENDER:$3|explain}} why you're suppressing {{GENDER:$1|this}} topic.",
	'flow-moderation-intro-delete-topic' => "Please {{GENDER:$3|explain}} why you're deleting {{GENDER:$1|this}} topic.",
	'flow-moderation-intro-hide-topic' => "Please {{GENDER:$3|explain}} why you're hiding {{GENDER:$1|this}} topic.",
	'flow-moderation-intro-restore-topic' => "Please {{GENDER:$3|explain}} why you're restoring {{GENDER:$1|this}} topic.",
...
$messages['de'] = array(
	...
	'flow-suppress-usertext' => "''Benutzername unterdrückt''",
	...
	'flow-rev-message-suppressed-post' => "$1 {{GENDER:$2|unterdrückte}} einen [$4 Kommentar] (''$5'').",
	...
	'flow-rev-message-suppressed-topic' => "$1 {{GENDER:$2|unterdrückte}} das [$4 Thema] (''$5'').",
...
$messages['fr'] = array(
	...
	'flow-suppress-usertext' => '« Nom d’utilisateur supprimé »',
	'flow-post-actions' => 'Actions',
	'flow-topic-actions' => 'Actions',
	'flow-cancel' => 'Annuler',
	...
	'flow-rev-message-hid-post' => "$1 {{GENDER:$2|a masqué}} un [$4 commentaire] ('' $5 '')..",
	'flow-rev-message-deleted-post' => "$1 {{GENDER:$2|a supprimé}} un [$4 commentaire] ('' $5 '')..",
	'flow-rev-message-suppressed-post' => "$1 {{GENDER:$2|a effacé}} un [$4 commentaire] ('' $5 '')..",
	'flow-rev-message-restored-post' => "$1 {{GENDER:$2|a rétabli}} un [$4 commentaire] ('' $5 '')..",
	'flow-rev-message-hid-topic' => "$1 {{GENDER:$2|a masqué}} le [$4 sujet] ('' $5 '')..",
	'flow-rev-message-deleted-topic' => "$1 {{GENDER:$2|a supprimé}} le [$4 sujet] ('' $5 '')..",
	'flow-rev-message-suppressed-topic' => "$1 {{GENDER:$2|a supprimé}} le [$4 sujet] ('' $5 '')..",
	'flow-rev-message-restored-topic' => "$1 {{GENDER:$2|a rétabli}} le [$4 sujet] ('' $5 '')..",
...
$messages['gl'] = array(
	...
	'flow-rev-message-suppressed-post' => 'Censurouse a mensaxe',
...
$1',
	...
	'flow-rev-message-reply-bundle' => "{{PLURAL:$1|נוספה '''הערה אחת'''|נוספו '''$1 הערות'''}}",
	...
	'flow-rev-message-suppressed-post' => "$1 {{GENDER:$2|העלים|העלימה}} [$4 הערה] (''$5'').",
	...
	'flow-rev-message-suppressed-topic' => "$1 {{GENDER:$2|העלים|העלימה}} את [$4 הנושא] (''$5'').",
...
$messages['ia'] = array(
	...
	'flow-suppress-usertext' => "''Nomine de usator supprimite''",
	...
	'flow-rev-message-suppressed-post' => '[[User:$1|$1]] {{GENDER:$1|supprimeva}} un [$3 commento].',
	...
	'flow-rev-message-suppressed-topic' => '[[User:$1|$1]] {{GENDER:$1|supprimeva}} le [$3 topico].',
...
[https://www.mediawiki.org/wiki/Special:MyLanguage/Flow_Portal bacheca dei flussi].',
	...
	'flow-suppress-usertext' => "''Nome utente soppresso''",
...
$messages['ja'] = array(
	...
	'flow-rev-message-reply-bundle' => "'''$1 {{PLURAL:$1|件のコメント}}'''が追加{{PLURAL:$1|されました}}。",
...
$messages['lb'] = array(
	...
	'flow-rev-message-hid-post' => "$1 {{GENDER:$2|huet}} eng [$4 Bemierkung] ('' $5 '') verstoppt.",
	...
	'flow-topic-comments' => '{{PLURAL:$1|0=Sidd deen éischten deen enge Bemierkung mecht!|Bemierkung ($1)}}', # Fuzzy
...
$messages['mk'] = array(
	...
	'flow-suppress-usertext' => "''Корисничкото име е притаено''",
	...
	'flow-rev-message-reply-bundle' => "'''{{PLURAL:$1|Додаден|Додадени}} {{PLURAL:$1|еден коментар|$1 коментари}}''' .",
	...
	'flow-rev-message-hid-post' => "$1 {{GENDER:$2|скри}} [$4 коментар] ('' $5 '').",
	'flow-rev-message-deleted-post' => "$1 {{GENDER:$2|избриша}} [$4 коментар] ('' $5 '').",
	'flow-rev-message-suppressed-post' => "$1 {{GENDER:$2|притаи}} [$4 коментар] ('' $5 '').",
	'flow-rev-message-restored-post' => "$1 {{GENDER:$2|поврати}} [$4 коментар] ('' $5 '').",
	'flow-rev-message-hid-topic' => "$1 {{GENDER:$2|ја скри}} [$4 темата] ('' $5 '').",
	'flow-rev-message-deleted-topic' => "$1 {{GENDER:$2|ја избриша}} [$4 темата] ('' $5 '').",
	'flow-rev-message-suppressed-topic' => "$1 {{GENDER:$2|ја притаи}} [$4 темата] ('' $5 '').",
	'flow-rev-message-restored-topic' => "$1 {{GENDER:$2|ја поврати}} [$4 темата] ('' $5 '').",
	...
	'flow-topic-comments' => '{{PLURAL:$1|0=Бидете први со коментар!|Коментари ($1)}}', # Fuzzy
...
$messages['nb'] = array(
	...
	'flow-rev-message-reply-bundle' => "'''$1 {{PLURAL:$1|kommentar|kommentarer}}''' {{PLURAL:$1|ble}} lagt til.",
	...
	'flow-rev-message-suppressed-post' => 'Sensurerte melding',
...
$messages['nl'] = array(
	...
	'flow-suppress-usertext' => "''Gebruikersnaam onderdrukt''",
	...
	'flow-rev-message-reply-bundle' => "Er {{PLURAL:$1|is|zijn}} '''$1 {{PLURAL:$1|reactie|reacties}}''' toegevoegd.",
	...
	'flow-rev-message-hid-post' => "$1 {{GENDER:$2|heeft}} een [$4 reactie] verborgen (''$5'').",
	'flow-rev-message-deleted-post' => "$1 {{GENDER:$2|heeft}} een [$4 reactie] verwijderd (''$5'').",
	'flow-rev-message-suppressed-post' => "$1 {{GENDER:$2|heeft}} een [$4 reactie] onderdrukt (''$5'').",
	'flow-rev-message-restored-post' => "$1 {{GENDER:$2|heeft}} een [$4 reactie] teruggeplaatst (''$5'').",
	'flow-rev-message-hid-topic' => "$1 {{GENDER:$2|heeft}} een [$4 onderwerp] verborgen (''$5'').",
	'flow-rev-message-deleted-topic' => "$1 {{GENDER:$2|heeft}} een [$4 onderwerp] verwijderd (''$5'').",
	'flow-rev-message-suppressed-topic' => "$1 {{GENDER:$2|heeft}} een [$4 onderwerp] onderdrukt (''$5'').",
	'flow-rev-message-restored-topic' => "$1 {{GENDER:$2|heeft}} een [$4 onderwerp] teruggeplaatst (''$5'').",
	...
	'flow-topic-comments' => '{{PLURAL:$1|0=Reageer als eerste!|Reactie|Reacties ($1)}}', # Fuzzy
...
$messages['roa-tara'] = array(
	...
	'flow-page-title' => '$1 &ndash; Flusse', # Fuzzy
...
$messages['ru'] = array(
	...
	'flow-rev-message-deleted-post' => "$1 удалил{{GENDER:$2||а}} [$4 комментарий] (''$5'').",
...
$messages['sv'] = array(
	...
	'flow-topic-comments' => '{{PLURAL:$1|0=Var först med att kommentera!|Kommentar ($1)}}', # Fuzzy
...
$messages['uk'] = array(
	...
	'flow-suppress-usertext' => "Ім'я користувача приховано",
	...
	'flow-rev-message-reply-bundle' => '$1 {{PLURAL:$1|коментар|коментарі|коментарів}} {{PLURAL:$1|був доданий|були додані}}.',
	...
	'flow-rev-message-hid-post' => "$1 {{GENDER:$2|приховав|приховала}} [коментар $4]('' $5 '').",
	'flow-rev-message-deleted-post' => "$1 {{GENDER:$2|видалив|видалила}} [коментар $4] ('' $5 '').",
	'flow-rev-message-suppressed-post' => "$1 {{GENDER:$2|подавив|подавила}} [коментар $4] ('' $5 '').",
	'flow-rev-message-restored-post' => "$1 {{GENDER:$2|відновив|відновила}} [коментар $4] ('' $5 '').",
	'flow-rev-message-hid-topic' => "$1 {{GENDER:$2|приховав|приховала}} [тему $4] ('' $5 '').",
	'flow-rev-message-deleted-topic' => "$1 {{GENDER:$2|вилучив|вилучила}} [тему $4] ('' $5 '').",
	'flow-rev-message-suppressed-topic' => "$1 {{GENDER:$2|прибрав|прибрала}} [тему $4] ('' $5 '').",
	'flow-rev-message-restored-topic' => "$1 {{GENDER:$2|відновив|відновила}} [тему $4] ('' $5 '').",
...
$messages['vi'] = array(
	...
	'flow-suppress-usertext' => "''Tên người dùng bị đàn áp''",
	...
	'flow-rev-message-hid-post' => "$1 {{GENDER:$2}}đã ẩn một [$4 bình luận] ('' $5 '').",
	'flow-rev-message-deleted-post' => "$1 {{GENDER:$2}}đã xóa một [$4 bình luận] ('' $5 '').",
	'flow-rev-message-suppressed-post' => '[[User:$1|$1]] {{GENDER:$1}}đã đàn áp một [$3 bình luận].',
	'flow-rev-message-restored-post' => "$1 {{GENDER:$2}}đã phục hồi một [$4 bình luận] ('' $5 '').",
	...
	'flow-topic-comments' => '{{PLURAL:$1|0=Hãy là người đầu tiên bình luận!|Bình luận ($1)}}', # Fuzzy
...
$messages['yi'] = array(
	...
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|האט באהאלטן}} א [$4 הערה] (״$5״).',
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|האט צוריקגעשטעלט}} א [$4 הערה] (״$5״).',
