...
abstract class BaseUrlGenerator {
	 ...
	 */
	protected function generateUrlData( $workflow, $action = 'view', array $query = array() ) {
...
class UrlGenerator extends BaseUrlGenerator {
	...
	public function paginateTopicsLink( Title $title = null, UUID $workflowId, PagerPage $page, $direction ) {
		...
		return new Anchor( wfMessage( "flow-paging-$direction" ), $linkTitle, $query );
	}
	...
	public function newTopicLink( Title $title = null, UUID $workflowId ) {
		...
		return new Anchor( wfMessage( 'flow-topic-action-new' ), $linkTitle, $query );
	}
	...
	public function replyPostLink( Title $title = null, UUID $workflowId, UUID $postId ) {
		...
		return new Anchor( wfMessage( 'flow-post-action-reply' ), $linkTitle, $query );
	}
	...
	public function editHeaderLink( Title $title = null, UUID $workflowId ) {
		...
		return new Anchor( wfMessage( 'flow-edit-header' ), $linkTitle, $query );
	}
	...
	public function editTitleLink( Title $title = null, UUID $workflowId ) {
		...
		return new Anchor( wfMessage( 'flow-edit-title' ), $linkTitle, $query );
	}
	...
	public function topicLink( Title $title = null, UUID $workflowId ) {
		...
		return new Anchor( wfMessage( 'flow-link-topic' ), $linkTitle, $query );
	}
	...
	public function postHistoryLink( Title $title = null, UUID $workflowId, UUID $postId ) {
		...
		return new Anchor( wfMessage( 'hist' ), $linkTitle, $query );
	}

	/**
	 * Show a specific revision of the specified post
	 *
	 * @param Title|null $title
	 * @param UUID $workflowId
	 * @param UUID $revId
	 * @return Anchor
	 */
	public function postRevisionLink( Title $title = null, UUID $workflowId, UUID $revId ) {
		list( $linkTitle, $query ) = $this->buildUrlData(
			$this->resolveTitle( $title, $workflowId ),
			'view',
			array(
		...
		return new Anchor( wfMessage( 'flow-post' ), $linkTitle, $query );
	}
	...
	public function diffHeaderLink( Title $title = null, UUID $workflowId, UUID $revId, UUID $oldRevId = null ) {
		...
		return new Anchor( wfMessage( 'diff' ), $linkTitle, $query );
	}
	...
	public function workflowLink( Title $title = null, UUID $workflowId ) {
		...
		return new Anchor( $linkTitle->getPrefixedText(), $linkTitle, $query );
	}
