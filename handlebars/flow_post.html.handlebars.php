					...
					<div class="flow-post">
						...
						<div class="flow-post-meta">
							<span class="flow-post-meta-actions">
								<a href="#flow-post-'.LCRun2::enc(((is_array($in) && isset($in['postId'])) ? $in['postId'] : null), $cx).'-form-content" class="flow-ui-progressive flow-ui-quiet">'.LCRun2::ch('l10n', Array('Reply'), 'enc', $cx).'</a>
