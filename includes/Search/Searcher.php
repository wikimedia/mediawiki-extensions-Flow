...
class Searcher {
	...
	public function setPages( array $pages ) {
		...
		foreach ( $pages as $page ) {
			// @todo: probably want to check if id is valid (!= 0)
			// @todo: probably don't want to be messing about with WikiPage objects anyway; by this point, we should just be dealing with (valid) ids already, I guess
