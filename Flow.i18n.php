...
$messages['en'] = array(
	...
	'flow-error-fail-load-history' => 'Fail to load history content.',
	'flow-error-missing-revision' => 'Could not find a revision to load flow content.',
	'flow-error-fail-commit' => 'Fail to save the flow content.',
	...
	'flow-error-fail-load' => 'Fail to load the requested data.',
	'flow-error-invalid-workflow' => 'Could find find the requested workflow.',
...
* $2: The actual latest revision id',
	...
	'flow-error-fail-load' => 'General error message when failing to load data.',
...
$messages['sv'] = array(
	...
	'flow-rev-message-reply-bundle' => '<strong>$1 {{PLURAL:$2|kommentar|kommentarer}}</strong> {{PLURAL:$2|lades till}}.', # Fuzzy
