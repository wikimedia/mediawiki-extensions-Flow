...
class FlowPage < WikiPage
  ...
  a(:first_topic_watch_link) do |watchlist_controls|
    watchlist_controls.first_topic_watchlist_container_element.link_element( css: ".flow-watch-link-watch" )
  end

  a(:first_topic_unwatch_link) do |watchlist_controls|
    watchlist_controls.first_topic_watchlist_container_element.link_element( css: ".flow-watch-link-unwatch" )
  end

  a(:first_topic_watchlist_loading_link) do |watchlist_controls|
    watchlist_controls.first_topic_watchlist_container_element.link_element( css: '.flow-api-inprogress' )
  end

  div(:board_watchlist_container, css:".flow-board-watch-link")

  a(:board_watch_link) do |watchlist_controls|
    watchlist_controls.board_watchlist_container_element.link_element( css: '.flow-watch-link-watch' )
  end
