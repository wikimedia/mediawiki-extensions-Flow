...
').'';},'flow_post_meta_actions' => function ($cx, $in) {return '<div class="flow-post-meta">
	...
	<span class="flow-post-timestamp">
		...
		' : '
			...
			<a href="'.htmlentities((string)((isset($in['links']['topic-history']['url']) && is_array($in['links']['topic-history'])) ? $in['links']['topic-history']['url'] : null), ENT_QUOTES, 'UTF-8').'" class="flow-timestamp-anchor">'.LCRun3::ch($cx, 'uuidTimestamp', Array(Array(((isset($in['lastEditId']) && is_array($in)) ? $in['lastEditId'] : null),false),Array()), 'encq').'</a>
		').'
	</span>
</div>
