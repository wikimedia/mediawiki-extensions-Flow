...
$messages['en'] = array(
	...
	'flow-rev-message-create-header' => "$1 {{GENDER:$1|created}} the board header.",
	'flow-rev-message-edit-header' => "$1 {{GENDER:$1|edited}} the board header.",
	'flow-rev-message-hid-post' => '$1 {{GENDER:$1|hid}} a [$3 comment] (\'\' $4 \'\').',
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$1|deleted}} a [$3 comment] (\'\' $4 \'\').',
	'flow-rev-message-censored-post' => '$1 {{GENDER:$1|suppressed}} a [$3 comment] (\'\' $4 \'\').',
	'flow-rev-message-restored-post' => '$1 {{GENDER:$1|restored}} a [$3 comment] (\'\' $4 \'\').',

	'flow-rev-message-hid-topic' => '$1 {{GENDER:$1|hid}} the [$3 topic] (\'\' $4 \'\').',
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$1|deleted}} the [$3 topic] (\'\' $4 \'\').',
	'flow-rev-message-censored-topic' => '$1 {{GENDER:$1|suppressed}} the [$3 topic] (\'\' $4 \'\').',
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$1|restored}} the [$3 topic] (\'\' $4 \'\').',
