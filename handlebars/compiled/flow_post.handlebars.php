<?php return function ($in, $debugopt = 1) {
	...
	<span class="flow-author">
		'.((LCRun3::ifvar($cx, ((is_array($in) && isset($in['links'])) ? $in['links'] : null))) ? '
			...
			' : '').'
			<span class="mw-usertoollinks">'.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in['links']) && isset($in['links']['talk'])) ? $in['links']['talk'] : null),'or',((is_array($in['links']) && isset($in['links']['block'])) ? $in['links']['block'] : null)),Array()), $in, function($cx, $in) {return '(';}).''.((LCRun3::ifvar($cx, ((is_array($in['links']) && isset($in['links']['talk'])) ? $in['links']['talk'] : null))) ? '<a href="'.htmlentities(((is_array($in['links']['talk']) && isset($in['links']['talk']['url'])) ? $in['links']['talk']['url'] : null), ENT_QUOTES, 'UTF-8').'"
					    class="'.((!LCRun3::ifvar($cx, ((is_array($in['links']['talk']) && isset($in['links']['talk']['exists'])) ? $in['links']['talk']['exists'] : null))) ? 'new ' : '').' flow-ui-tooltip-target"
					    title="'.htmlentities(((is_array($in['links']['talk']) && isset($in['links']['talk']['title'])) ? $in['links']['talk']['title'] : null), ENT_QUOTES, 'UTF-8').'">
					    	'.LCRun3::ch($cx, 'l10n', Array(Array('talkpagelinktext'),Array()), 'encq').'
					</a>' : '').''.((LCRun3::ifvar($cx, ((is_array($in['links']) && isset($in['links']['talk'])) ? $in['links']['talk'] : null))) ? ''.((LCRun3::ifvar($cx, ((is_array($in['links']) && isset($in['links']['block'])) ? $in['links']['block'] : null))) ? '|' : '').'' : '').''.((LCRun3::ifvar($cx, ((is_array($in['links']) && isset($in['links']['block'])) ? $in['links']['block'] : null))) ? '<a class="'.((!LCRun3::ifvar($cx, ((is_array($in['links']['block']) && isset($in['links']['block']['exists'])) ? $in['links']['block']['exists'] : null))) ? 'new ' : '').'
					   ...
					   title="'.htmlentities(((is_array($in['links']['block']) && isset($in['links']['block']['title'])) ? $in['links']['block']['title'] : null), ENT_QUOTES, 'UTF-8').'">
					   	'.LCRun3::ch($cx, 'l10n', Array(Array('blocklink'),Array()), 'encq').'
					</a>' : '').''.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in['links']) && isset($in['links']['talk'])) ? $in['links']['talk'] : null),'or',((is_array($in['links']) && isset($in['links']['block'])) ? $in['links']['block'] : null)),Array()), $in, function($cx, $in) {return ')';}).'</span>
		' : '').'
	</span>
' : '
