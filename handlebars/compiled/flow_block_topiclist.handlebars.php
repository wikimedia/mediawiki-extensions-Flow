...
'.$sp.'	'.((LCRun3::ifvar($cx, ((isset($in['isLocked']) && is_array($in)) ? $in['isLocked'] : null))) ? '[OK] ' : '').''.LCRun3::ch($cx, 'escapeContent', array(array(((isset($in['content']['format']) && is_array($in['content'])) ? $in['content']['format'] : null),((isset($in['content']['content']) && is_array($in['content'])) ? $in['content']['content'] : null)),array()), 'encq').'</h2>
...
'.$sp.'		'.((LCRun3::ifvar($cx, ((isset($in['isLocked']) && is_array($in)) ? $in['isLocked'] : null))) ? 'closed ' : '').'
...
'.$sp.'').'	</a>
'.$sp.'</div>
'.$sp.'<h1>moderateState: '.htmlentities((string)((isset($in['moderateState']) && is_array($in)) ? $in['moderateState'] : null), ENT_QUOTES, 'UTF-8').' isLocked: '.htmlentities((string)((isset($in['isLocked']) && is_array($in)) ? $in['isLocked'] : null), ENT_QUOTES, 'UTF-8').' isModerated: '.htmlentities((string)((isset($in['isModerated']) && is_array($in)) ? $in['isModerated'] : null), ENT_QUOTES, 'UTF-8').'</h1>
