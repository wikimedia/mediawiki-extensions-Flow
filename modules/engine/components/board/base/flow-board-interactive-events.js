...
( function ( $, mw ) {
	 ...
	 * @return {FlowBoardComponentInteractiveEventsMixin}
	...
	mw.flow.extendComponent( 'board', FlowBoardComponentInteractiveEventsMixin );
}( jQuery, mediaWiki ) );