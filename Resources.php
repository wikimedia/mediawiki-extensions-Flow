...
$wgResourceModules += array(
	'ext.flow.templating' => $flowTemplatingResourceTemplate + array(
		...
		'templates' => array(
			...
			"flow_moderate_topic_success.handlebars",
		...
		'messages' => array(
			...
			// Moderation ajax success
			'flow-moderation-success-hide-topic',
			'flow-moderation-success-delete-topic',
			'flow-moderation-success-suppress-topic',
		),
	),
