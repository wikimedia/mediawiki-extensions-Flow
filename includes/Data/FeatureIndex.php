...
abstract class FeatureIndex implements Index {
	...
	public function findMulti( array $queries, array $options = array() ) {
		...
		// $inCache will be an array where values are cache keys and keys are
		// the same index as their corresponding $queries
		...
		foreach ( $keysFromCache as $i => $key ) {
