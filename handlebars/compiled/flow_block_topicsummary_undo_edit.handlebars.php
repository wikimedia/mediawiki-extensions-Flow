...
' : '').'
	<form method="POST" action="'.htmlentities((string)((isset($in['links']['undo-edit-header']['url']) && is_array($in['links']['undo-edit-header'])) ? $in['links']['undo-edit-header']['url'] : null), ENT_QUOTES, 'UTF-8').'" class="flow-post" data-module="topicsummary">
		...
		<div class="flow-editor">
			<textarea name="topicsummary_summary"
			          class="mw-ui-input mw-editfont-'.htmlentities((string)((isset($cx['sp_vars']['root']['rootBlock']['editFont']) && is_array($cx['sp_vars']['root']['rootBlock'])) ? $cx['sp_vars']['root']['rootBlock']['editFont'] : null), ENT_QUOTES, 'UTF-8').'"
			          data-role="content"
