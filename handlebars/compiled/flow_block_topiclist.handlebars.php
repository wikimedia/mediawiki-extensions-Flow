...
<a href="#topics/topics"  data-flow-interactive-handler="collapserGroupToggle" class="flow-board-collapser-full flow-board-navigator-right flow-board-navigator-cap"><span class="wikiglyph wikiglyph-stripe-expanded flow-ui-tooltip-target" title="'.LCRun3::ch($cx, 'l10n', Array(Array('flow-toggle-topics'),Array()), 'encq').'"></span></a>
		...
		<a href="javascript:void(0);"
		   ...
		   data-flow-menu-target="< .flow-board-navigation .flow-menu">'.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['sortby'])) ? $in['sortby'] : null),((is_array($in) && isset($in['\'equalTo\''])) ? $in['\'equalTo\''] : null),'updated'),Array()), $in, function($cx, $in) {return '
		...
		<div class="flow-menu flow-menu-inverted">
			...
			'.((LCRun3::ifvar($cx, ((is_array($in['links']) && isset($in['links']['board-sort'])) ? $in['links']['board-sort'] : null))) ? '
				<ul class="mw-ui-button-container flow-list">
					<li><a class="mw-ui-button mw-ui-quiet '.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['sortby'])) ? $in['sortby'] : null),((is_array($in) && isset($in['\'equalTo\''])) ? $in['\'equalTo\''] : null),'updated'),Array()), $in, function($cx, $in) {return 'flow-board-navigator-link-highlight';}).'"
					...
					<li><a class="mw-ui-button mw-ui-quiet '.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['sortby'])) ? $in['sortby'] : null),((is_array($in) && isset($in['\'equalTo\''])) ? $in['\'equalTo\''] : null),''),Array()), $in, function($cx, $in) {return 'flow-board-navigator-link-highlight';}).'"
...
<div class="flow-board">
	...
	<div class="flow-newtopic-container">
		<div class="flow-nojs">
			<a href="'.htmlentities(((is_array($in['links']) && isset($in['links']['newtopic'])) ? $in['links']['newtopic'] : null), ENT_QUOTES, 'UTF-8').'">'.LCRun3::ch($cx, 'l10n', Array(Array('flow-newtopic-start-placeholder'),Array()), 'encq').'</a>
		</div>
...
' : '').'
	...
	'.LCRun3::hbch($cx, 'eachPost', Array(Array($cx['scopes'][0],$in),Array()), $in, function($cx, $in) {return '
		<div class="flow-topic flow-element-collapsible '.((!LCRun3::ifvar($cx, ((is_array($in) && isset($in['isPreview'])) ? $in['isPreview'] : null))) ? 'flow-load-interactive' : '').' '.((LCRun3::ifvar($cx, ((is_array($in) && isset($in['moderateState'])) ? $in['moderateState'] : null))) ? 'flow-topic-moderatestate-'.htmlentities(((is_array($in) && isset($in['moderateState'])) ? $in['moderateState'] : null), ENT_QUOTES, 'UTF-8').'' : '').'
	'.((LCRun3::ifvar($cx, ((is_array($in) && isset($in['isModerated'])) ? $in['isModerated'] : null))) ? 'flow-topic-moderated
		'.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['moderateState'])) ? $in['moderateState'] : null),((is_array($in) && isset($in['\'notEqualTo\''])) ? $in['\'notEqualTo\''] : null),((is_array($in) && isset($in['\'close\''])) ? $in['\'close\''] : null)),Array()), $in, function($cx, $in) {return 'flow-element-collapsed';}).'
	' : '').'"
...
'.((LCRun3::ifvar($cx, ((is_array($in) && isset($in['isModerated'])) ? $in['isModerated'] : null))) ? '
	<div class="flow-moderated-topic-title flow-ui-text-truncated"><span
		class="wikiglyph '.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['moderateState'])) ? $in['moderateState'] : null),((is_array($in) && isset($in['\'equalTo\''])) ? $in['\'equalTo\''] : null),'close'),Array()), $in, function($cx, $in) {return 'wikiglyph-stop';}).''.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['moderateState'])) ? $in['moderateState'] : null),((is_array($in) && isset($in['\'equalTo\''])) ? $in['\'equalTo\''] : null),'hide'),Array()), $in, function($cx, $in) {return 'wikiglyph-flag';}).''.LCRun3::hbch($cx, 'ifCond', Array(Array(((is_array($in) && isset($in['moderateState'])) ? $in['moderateState'] : null),((is_array($in) && isset($in['\'equalTo\''])) ? $in['\'equalTo\''] : null),'delete'),Array()), $in, function($cx, $in) {return 'wikiglyph-trash';}).'"></span>
