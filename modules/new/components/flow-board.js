...
( function ( $, mw ) {
	...
	( function () {
		 ...
		 * @return {Object}
		 */
		FlowBoardComponent.UI.events.apiPreHandlers.prepareEditor = function ( event ) {
		...
		FlowBoardComponent.UI.events.interactiveHandlers.apiRequest = function ( event ) {
			...
			// Let generic pre-handlers take care of editors & edit conflicts
			preHandlerReturns.push( FlowBoardComponent.UI.events.apiPreHandlers.prepareEditor.apply( _this, arguments ) );
