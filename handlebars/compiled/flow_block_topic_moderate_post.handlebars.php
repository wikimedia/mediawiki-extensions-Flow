...
' : '').'
	...
	' : '').'>
		<div class="flow-post-main '.((LCRun3::ifvar($cx, ((is_array($in) && isset($in['isModerated'])) ? $in['isModerated'] : null))) ? 'flow-collapsible-element flow-moderated-post-content flow-component flow-element-collapsed' : '').'">
