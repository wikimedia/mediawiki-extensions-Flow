	...
	public static function imageRemovalProvider() {
		return [
			[
				...
				'<p><span class="mw-default-size" typeof="mw:Image"><a href="./File:Image.jpg">' .
					'<img resource="./File:Image.jpg" src="//upload.wikimedia.org/wikipedia/com' .
					'mons/7/78/Image.jpg" height="500" width="500"></a></span> and other stuff</p>',
				// input html
				'<p><span class="mw-default-size" typeof="mw:Image"><a href="./File:Image.jpg">' .
					'<img resource="./File:Image.jpg" src="//upload.wikimedia.org/wikipedia/com' .
					'mons/7/78/Image.jpg" height="500" width="500"></a></span> and other stuff</p>',
