	...
	public function getWhatLinksHereProps( $row, $from, $to ) {
		...
		foreach( $references as $reference ) {
			try {
				...
				// Expected Cross wiki exception in here, ignore them for now. To fix the problem,
				// add a wiki field to loadReferenceForPage() query, then we can remove catcthing
				// the exception in here
			}
		}
