...
class ReferenceExtractor {
	...
	public function getReferences( Workflow $workflow, UUID $revision, $text ) {
	...
	public function instantiateReference( Workflow $workflow, UUID $revision, $targetType, $refType, $value ) {
		if ( $targetType === 'url' ) {
