...
$messages['de'] = array(
	...
	'flow-rev-message-deleted-topic' => '[[User:$1|$1]] {{GENDER:$1|löschte}} das [$3 Thema].',
...
$messages['ia'] = array(
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|cambiava}} le titulo del topico de $4 in [$2 $3].',
	'flow-rev-message-create-header' => '[[User:$1|$1]] {{GENDER:$1|creava}} le titulo del tabuliero.',
	'flow-rev-message-edit-header' => '[[User:$1|$1]] {{GENDER:$1|modificava}} le titulo del tabuliero.',
	'flow-rev-message-hid-post' => '[[User:$1|$1]] {{GENDER:$1|celava}} un [$3 commento].',
	'flow-rev-message-deleted-post' => '[[User:$1|$1]] {{GENDER:$1|deleva}} un [$3 commento].',
	'flow-rev-message-censored-post' => '[[User:$1|$1]] {{GENDER:$1|supprimeva}} un [$3 commento].',
	'flow-rev-message-restored-post' => '[[User:$1|$1]] {{GENDER:$1|restaurava}} un [$3 commento].',
	'flow-rev-message-hid-topic' => '[[User:$1|$1]] {{GENDER:$1|celava}} le [$3 topico].',
	'flow-rev-message-deleted-topic' => '[[User:$1|$1]] {{GENDER:$1|deleva}} le [$3 topico].',
	'flow-rev-message-censored-topic' => '[[User:$1|$1]] {{GENDER:$1|supprimeva}} le [$3 topico].',
	'flow-rev-message-restored-topic' => '[[User:$1|$1]] {{GENDER:$1|restaurava}} le [$3 topico].',
...
$messages['ja'] = array(
	...
	'flow-rev-message-deleted-topic' => '[[User:$1|$1]] が[$3 話題]を{{GENDER:$1|削除}}',
...
$messages['lb'] = array(
	...
	'flow-rev-message-deleted-topic' => "[[User:$1|$1]] {{GENDER:$1|huet}} d'[Thema $3] geläscht.",
...
$messages['mk'] = array(
	...
	'flow-rev-message-deleted-topic' => '[[User:$1|$1]] {{GENDER:$1|ја избриша}} [$3 темата].',
...
$messages['ne'] = array(
	...
	'flow-rev-message-reply-bundle' => "'''$1 {{PLURAL:$1|टिप्पणी|टिप्पणीहरू}}''' {{PLURAL:$1|थपिएको|थपिएका}} थिए ।",
...
$messages['nl'] = array(
	...
	'flow-error-external-multi' => 'Fouten zijn opgetreden. <br /> $ 1', # Fuzzy
...
$messages['uk'] = array(
	...
	'flow-rev-message-deleted-topic' => '[[User:$1|$1]] {{GENDER:$1|вилучив|вилучила}} [тему $3].',
