( function ( $, mw ) {
	...
	/**
	 * Initialize upon creating new object
	 */
	...
	mw.flow.action.topic.close.prototype.submitFunction = function ( data, content ) {
		// Todo - send moderate-topic action to Topic and TopicSummary block
		// so the topic is closed and the summary is added
	};
	...
	mw.flow.action.topic.close.prototype.render = function ( output ) {
		// Todo - hide the entire topic and show the summary
	};
