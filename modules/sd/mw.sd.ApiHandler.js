( function ( $ ) {
	 ...
	 *  is done, with the API result.
	 */
	mw.sd.APIHandler.prototype.postEdit = function ( submodule, requestParams ) {
	 ...
	 */
	mw.sd.APIHandler.prototype.saveReply = function ( topicId, replyTo, content, format, captcha ) {
		var params = {
			action: 'flow',
			submodule: 'reply',
			page: 'Topic:' + topicId,
	 ...
	 */
	mw.sd.APIHandler.prototype.saveNewTopic = function ( title, content, format, captcha ) {
		var params = {
			submodule: 'new-topic',
			page: this.page,
			nttopic: title,
	 ...
	 */
	mw.sd.APIHandler.prototype.saveDescription = function ( content, format, captcha ) {
		var xhr,
			params = {
				page: this.page,
				ehcontent: content,
	 ...
	 */
	mw.sd.APIHandler.prototype.savePost = function ( topicId, postId, content, format, captcha ) {
		var params = {
			page: this.getTopicTitle( topicId ),
			epcontent: content,
			epformat: format,
	 ...
	 */
	mw.sd.APIHandler.prototype.saveTopicSummary = function ( topicId, content, format, captcha ) {
		var params = {
			page: this.getTopicTitle( topicId ),
			etssummary: content,
			etsformat: format,
	 ...
	 * @return {jQuery.Promise} Promise that is resolved with workflow id
	 */
	mw.sd.APIHandler.prototype.saveTopicTitle = function ( topicId, content, captcha ) {
		var params = {
			page: this.getTopicTitle( topicId ),
			etcontent: content,
	 ...
	 * @return {jQuery.Promise} Promise that is resolved with workflow id
	 */
	mw.sd.APIHandler.prototype.lockTopic = function ( topicId, moderationState, reasonMsgKey ) {
		var params = {
			page: this.getTopicTitle( topicId ),
