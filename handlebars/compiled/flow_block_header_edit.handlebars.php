<?php return function ($in, $debugopt = 1) {
	...
	<div class="flow-board-header-detail-view"></div>
	<div class="flow-board-header-edit-view">
		...
		<form method="POST" action="'.htmlentities(((is_array($in['revision']['actions']['edit']) && isset($in['revision']['actions']['edit']['url'])) ? $in['revision']['actions']['edit']['url'] : null), ENT_QUOTES, 'UTF-8').'" data-flow-initial-state="hidden" flow-api-action="edit-header">
