...
' : '').'
	...
	<div class="flow-form-actions flow-form-collapsible">
		<button data-role="submit"
		        ...
		        class="flow-ui-button mw-ui-button flow-ui-constructive mw-ui-constructive">'.LCRun3::ch($cx, 'l10n', Array('flow-edit-title-submit'), 'encq').'</button>
		<button data-role="cancel"
		        data-flow-interactive-handler="cancelForm"
		        class="flow-ui-button mw-ui-button flow-ui-destructive mw-ui-destructive flow-ui-quiet mw-ui-quiet">'.LCRun3::ch($cx, 'l10n', Array('flow-cancel'), 'encq').'</button>
