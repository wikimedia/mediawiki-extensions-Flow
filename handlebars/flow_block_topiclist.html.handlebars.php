					...
					<div class="flow-board">
						...
						<div class="flow-topic-titlebar flow-click-interactive" data-flow-interactive-handler="topicCollapserToggle" tabindex="0">
							...
							<div class="flow-topic-meta">
								<a class="flow-ui-button flow-ui-progressive flow-ui-quiet flow-ui-inline" href="#flow-topic-'.LCRun2::enc(((is_array($in) && isset($in['id'])) ? $in['id'] : null), $cx).'-form-content">'.LCRun2::ch('l10n', Array('Reply',((is_array($in) && isset($in['author'])) ? $in['author'] : null)), 'enc', $cx).'</a>
								...
								'.((LCRun2::ifvar(((is_array($in) && isset($in['last_updated'])) ? $in['last_updated'] : null))) ? '
									<!--span class="WikiFont WikiFont-speech-bubbles"></span--> '.LCRun2::ch('timestamp', Array(((is_array($in) && isset($in['lastUpdated'])) ? $in['lastUpdated'] : null),'active_ago'), 'enc', $cx).'
								' : '
									<!--span class="WikiFont WikiFont-speech-bubble"></span--> '.LCRun2::ch('uuidTimestamp', Array(((is_array($in) && isset($in['revisionId'])) ? $in['revisionId'] : null),'started_ago'), 'enc', $cx).'
								').'
							</div>
							...
							<div class="flow-menu">
								...
								<ul class="flow-ui-button-container">
									'.((LCRun2::ifvar(((is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null))) ? '
										<li><a class="flow-ui-button flow-ui-progressive flow-ui-quiet flow-ui-thin" href="'.LCRun2::enc(((is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null), $cx).'"><span class="WikiFont WikiFont-lock"></span> '.LCRun2::ch('l10n', Array('Lock'), 'enc', $cx).'</a></li>
									' : '').'
									'.((LCRun2::ifvar(((is_array($in['actions']) && isset($in['actions']['hide'])) ? $in['actions']['hide'] : null))) ? '
										<li><a class="flow-ui-button flow-ui-quiet flow-ui-thin" href="'.LCRun2::enc(((is_array($in['actions']) && isset($in['actions']['hide'])) ? $in['actions']['hide'] : null), $cx).'"><span class="WikiFont WikiFont-eye-lid"></span> '.LCRun2::ch('l10n', Array('Hide'), 'enc', $cx).'</a></li>
									' : '').'
									'.((LCRun2::ifvar(((is_array($in['actions']) && isset($in['actions']['delete'])) ? $in['actions']['delete'] : null))) ? '
										<li><a class="flow-ui-button flow-ui-regressive flow-ui-quiet flow-ui-thin" href="'.LCRun2::enc(((is_array($in['actions']) && isset($in['actions']['delete'])) ? $in['actions']['delete'] : null), $cx).'"><span class="WikiFont WikiFont-trash-slash"></span> '.LCRun2::ch('l10n', Array('Delete'), 'enc', $cx).'</a></li>
									' : '').'
									'.((LCRun2::ifvar(((is_array($in['actions']) && isset($in['actions']['suppress'])) ? $in['actions']['suppress'] : null))) ? '
										<li><a class="flow-ui-button flow-ui-destructive flow-ui-quiet flow-ui-thin" href="'.LCRun2::enc(((is_array($in['actions']) && isset($in['actions']['suppress'])) ? $in['actions']['suppress'] : null), $cx).'"><span class="WikiFont WikiFont-block-slash"></span> '.LCRun2::ch('l10n', Array('Suppress'), 'enc', $cx).'</a></li>
									' : '').'
								</ul>
							</div>
						</div>
						...
						<textarea id="flow-post-'.LCRun2::enc(((is_array($in) && isset($in['id'])) ? $in['id'] : null), $cx).'-form-content" data-flow-expandable="true" class="mw-ui-input" type="text" placeholder="'.LCRun2::ch('l10n', Array('Reply_to_author_name',((is_array($in) && isset($in['author'])) ? $in['author'] : null)), 'enc', $cx).'"></textarea>
