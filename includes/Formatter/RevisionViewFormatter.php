...
class RevisionViewFormatter {
	...
	/**
	 * Overwrite parent method to generate necessary links because revision
	 * single and diff view are not revision change types
	 * @param FormatterRow
	 */
...
class RevisionDiffViewFormatter extends RevisionViewFormatter {
	...
	public function formatApi( FormatterRow $newRow, FormatterRow $oldRow, IContextSource $ctx ) {
		$oldRes = parent::formatApi( $oldRow, $ctx );
		$newRes = parent::formatApi( $newRow, $ctx );
