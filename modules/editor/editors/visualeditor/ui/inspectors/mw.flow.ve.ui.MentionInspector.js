( function ( mw, OO, ve ) {
	...
	mw.flow.ve.ui.MentionInspector.static.template = 'ping'; // XXX: Needs to be configurable
		...
		if ( action === 'remove' || action === 'done' ) {
			return new OO.ui.Process( function () {
				var surfaceModel = this.getFragment().getSurface(),
					transclusionModelPlain = this.transclusionModel.getPlainObject();
