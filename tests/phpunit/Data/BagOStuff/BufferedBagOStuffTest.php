...
class BufferedBagOStuffTest extends MediaWikiTestCase {
	...
	public function testCas() {
		...
		$this->assertEquals( 'updated-value', $this->bufferedCache->get( 'key' ) );
		$this->assertEquals( 'value', $this->cache->get( 'key' ) );
	...
	public function testConsecutiveCas() {
		...
		// check that the value has been CAS'ed to bufferedcache (only)
		$this->assertEquals( 'updated-value-2', $this->bufferedCache->get( 'key' ) );
		$this->assertEquals( 'value', $this->cache->get( 'key' ) );
	...
	public function testCasFailImmediately() {
		...
		$casToken = null;
		$this->bufferedCache->get( 'key', $casToken );
		$this->bufferedCache->cas( 'wrong-token', 'key', 'updated-value' );
