...
abstract class AbstractFormatter {
	...
	protected function getTitleLink( array $data, FormatterRow $row, IContextSource $ctx ) {
		if ( isset( $data['links']['topic'] ) && isset( $data['properties']['topic-of-post'] ) ) {
			/** @var \Flow\Anchor $topic */
			$topic = $data['links']['topic'];
			$topic->setMessage( $data['properties']['topic-of-post'] );
			...
			return Linker::link( $row->workflow->getArticleTitle() );
		}
	}
}
