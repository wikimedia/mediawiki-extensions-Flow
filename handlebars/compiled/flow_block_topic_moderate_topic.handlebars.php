...
'.$sp.'' : '').'</div>
';},
'flow_moderate_topic' => function ($cx, $in, $sp) {return ''.$sp.'<form method="POST" action="'.LR::encq($cx, LR::hbch($cx, 'moderationAction', array(array(((is_array($in) && isset($in['actions'])) ? $in['actions'] : null),(isset($cx['sp_vars']['root']['submitted']['moderationState']) ? $cx['sp_vars']['root']['submitted']['moderationState'] : null)),array()), 'encq', $in)).'">
...
'.$sp.''.((LR::ifvar($cx, ((is_array($in) && isset($in['links'])) ? $in['links'] : null), false)) ? ''.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['userpage'])) ? $in['links']['userpage'] : null), false)) ? '			<a href="'.LR::encq($cx, ((isset($in['links']['userpage']) && is_array($in['links']['userpage']) && isset($in['links']['userpage']['url'])) ? $in['links']['userpage']['url'] : null)).'"
'.$sp.'			   '.((!LR::ifvar($cx, ((is_array($in) && isset($in['name'])) ? $in['name'] : null), false)) ? 'title="'.LR::encq($cx, ((isset($in['links']['userpage']) && is_array($in['links']['userpage']) && isset($in['links']['userpage']['title'])) ? $in['links']['userpage']['title'] : null)).'"' : '').'
...
'.$sp.'' : '').''.((LR::ifvar($cx, ((is_array($in) && isset($in['name'])) ? $in['name'] : null), false)) ? '<bdi>'.LR::encq($cx, ((is_array($in) && isset($in['name'])) ? $in['name'] : null)).'</bdi>' : ''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-anonymous'),array()), 'encq', $in)).'').''.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['userpage'])) ? $in['links']['userpage'] : null), false)) ? '</a>' : '').'<span class="mw-usertoollinks flow-pipelist">
...
'.$sp.''.((LR::ifvar($cx, ((is_array($in) && isset($in['isOriginalContent'])) ? $in['isOriginalContent'] : null), false)) ? '			<a href="'.LR::encq($cx, ((isset($in['links']['topic-history']) && is_array($in['links']['topic-history']) && isset($in['links']['topic-history']['url'])) ? $in['links']['topic-history']['url'] : null)).'" class="flow-timestamp-anchor">
'.$sp.'				'.LR::encq($cx, LR::hbch($cx, 'uuidTimestamp', array(array(((is_array($in) && isset($in['postId'])) ? $in['postId'] : null)),array()), 'encq', $in)).'
'.$sp.'			</a>
'.$sp.'' : '			<span>
'.$sp.''.LR::hbbch($cx, 'ifCond', array(array(((isset($in['creator']) && is_array($in['creator']) && isset($in['creator']['name'])) ? $in['creator']['name'] : null),'===',((isset($in['lastEditUser']) && is_array($in['lastEditUser']) && isset($in['lastEditUser']['name'])) ? $in['lastEditUser']['name'] : null)),array()), $in, false, function($cx, $in)use($sp){return '					'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-edited'),array()), 'encq', $in)).'
'.$sp.'';}, function($cx, $in)use($sp){return '					'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-edited-by',((isset($in['lastEditUser']) && is_array($in['lastEditUser']) && isset($in['lastEditUser']['name'])) ? $in['lastEditUser']['name'] : null)),array()), 'encq', $in)).'
'.$sp.'';}).'			</span>
'.$sp.'			<a href="'.LR::encq($cx, ((isset($in['links']['diff-prev']) && is_array($in['links']['diff-prev']) && isset($in['links']['diff-prev']['url'])) ? $in['links']['diff-prev']['url'] : null)).'" class="flow-timestamp-anchor">'.LR::encq($cx, LR::hbch($cx, 'uuidTimestamp', array(array(((is_array($in) && isset($in['lastEditId'])) ? $in['lastEditId'] : null)),array()), 'encq', $in)).'</a>
'.$sp.'').'	</span>
'.$sp.'</div>
';},
...
'.$sp.''.LR::wi($cx, ((is_array($in) && isset($in['creator'])) ? $in['creator'] : null), null, $in, function($cx, $in)use($sp){return ''.LR::p($cx, 'flow_post_author', array(array($in),array()),0, '		').'';}).'
'.$sp.''.((LR::ifvar($cx, ((is_array($in) && isset($in['isModerated'])) ? $in['isModerated'] : null), false)) ? '		<div class="flow-moderated-post-content">
'.$sp.''.LR::p($cx, 'flow_post_moderation_state', array(array($in),array()),0, '			').'		</div>
'.$sp.'' : '').'
'.$sp.'	<div class="flow-post-content mw-parser-output">
'.$sp.'		'.LR::encq($cx, LR::hbch($cx, 'escapeContent', array(array(((isset($in['content']) && is_array($in['content']) && isset($in['content']['format'])) ? $in['content']['format'] : null),((isset($in['content']) && is_array($in['content']) && isset($in['content']['content'])) ? $in['content']['content'] : null)),array()), 'encq', $in)).'
'.$sp.'	</div>
'.$sp.'
...
'.$sp.'	<input type="hidden" name="topic_prev_revision" value="'.LR::encq($cx, ((is_array($in) && isset($in['revisionId'])) ? $in['revisionId'] : null)).'" />
...
'.$sp.'	<div class="flow-form-actions flow-form-collapsible">
'.$sp.'		<button class="mw-ui-button mw-ui-progressive"
'.$sp.'		        data-flow-api-handler="submitEditPost">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-post-action-edit-post-submit'),array()), 'encq', $in)).'</button>
...
'.$sp.''.LR::sec($cx, ((is_array($in) && isset($in['replies'])) ? $in['replies'] : null), null, $in, true, function($cx, $in)use($sp){return ''.LR::hbbch($cx, 'eachPost', array(array((isset($cx['sp_vars']['root']['rootBlock']) ? $cx['sp_vars']['root']['rootBlock'] : null),$in),array()), $in, false, function($cx, $in)use($sp){return '			<!-- eachPost nested replies -->
...
'.$sp.'';}).'';}).''.LR::hbbch($cx, 'ifCond', array(array((isset($cx['sp_vars']['root']['rootBlock']['submitted']['postId']) ? $cx['sp_vars']['root']['rootBlock']['submitted']['postId'] : null),'===',((is_array($in) && isset($in['postId'])) ? $in['postId'] : null)),array()), $in, false, function($cx, $in)use($sp){return ''.LR::hbbch($cx, 'ifCond', array(array((isset($cx['sp_vars']['root']['rootBlock']['submitted']['action']) ? $cx['sp_vars']['root']['rootBlock']['submitted']['action'] : null),'===','reply'),array()), $in, false, function($cx, $in)use($sp){return ''.LR::p($cx, 'flow_reply_form', array(array($in),array()),0, '			').'';}).'';}).'</div>
';},
'flow_post_partial' => function ($cx, $in, $sp) {return ''.$sp.''.LR::wi($cx, ((is_array($in) && isset($in['revision'])) ? $in['revision'] : null), null, $in, function($cx, $in)use($sp){return '	<div id="flow-post-'.LR::encq($cx, ((is_array($in) && isset($in['postId'])) ? $in['postId'] : null)).'"
'.$sp.'	     class="flow-post'.((LR::ifvar($cx, ((is_array($in) && isset($in['isMaxThreadingDepth'])) ? $in['isMaxThreadingDepth'] : null), false)) ? ' flow-post-max-depth' : '').'"
'.$sp.'	     data-flow-id="'.LR::encq($cx, ((is_array($in) && isset($in['postId'])) ? $in['postId'] : null)).'"
'.$sp.'	>
'.$sp.''.((LR::ifvar($cx, ((is_array($in) && isset($in['isModerated'])) ? $in['isModerated'] : null), false)) ? ''.LR::hbbch($cx, 'ifCond', array(array((isset($cx['sp_vars']['root']['rootBlock']['submitted']['showPostId']) ? $cx['sp_vars']['root']['rootBlock']['submitted']['showPostId'] : null),'===',((is_array($in) && isset($in['postId'])) ? $in['postId'] : null)),array()), $in, false, function($cx, $in)use($sp){return ''.LR::p($cx, 'flow_post_inner', array(array($in),array()),0, '				').'';}, function($cx, $in)use($sp){return '				<div class="flow-post-main flow-post-moderated">
'.$sp.'					<span class="flow-moderated-post-content">
'.$sp.''.LR::p($cx, 'flow_post_moderation_state', array(array($in),array()),0, '						').'					</span>
'.$sp.'				</div>
'.$sp.'';}).'' : ''.LR::hbbch($cx, 'ifCond', array(array((isset($cx['sp_vars']['root']['rootBlock']['submitted']['action']) ? $cx['sp_vars']['root']['rootBlock']['submitted']['action'] : null),'===','edit-post'),array()), $in, false, function($cx, $in)use($sp){return ''.LR::hbbch($cx, 'ifCond', array(array((isset($cx['sp_vars']['root']['rootBlock']['submitted']['postId']) ? $cx['sp_vars']['root']['rootBlock']['submitted']['postId'] : null),'===',((is_array($in) && isset($in['postId'])) ? $in['postId'] : null)),array()), $in, false, function($cx, $in)use($sp){return ''.LR::p($cx, 'flow_edit_post', array(array($in),array()),0, '					').'';}, function($cx, $in)use($sp){return ''.LR::p($cx, 'flow_post_inner', array(array($in),array()),0, '					').'';}).'';}, function($cx, $in)use($sp){return ''.LR::p($cx, 'flow_post_inner', array(array($in),array()),0, '				').'';}).'').'
...
'.LR::sec($cx, ((is_array($in) && isset($in['roots'])) ? $in['roots'] : null), null, $in, true, function($cx, $in) {return ''.LR::hbbch($cx, 'eachPost', array(array((isset($cx['sp_vars']['root']) ? $cx['sp_vars']['root'] : null),$in),array()), $in, false, function($cx, $in) {return ''.LR::p($cx, 'flow_moderate_topic', array(array($in),array()),0, '			').''.LR::p($cx, 'flow_post_partial', array(array($in),array()),0, '			').'';}).'';}).'</div>
';
};