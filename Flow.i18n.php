...
$messages['ja'] = array(
	...
	'flow-error-fail-load-history' => '履歴の本文を読み込めませんでした。',
	'flow-error-missing-revision' => 'Flow の本文を読み込むための版が見つかりませんでした。',
	'flow-error-fail-commit' => 'Flow の本文を保存できませんでした。',
	'flow-error-insufficient-permission' => 'コンテンツにアクセスするのに十分な権限がありません。',
	...
	'flow-error-fail-load-data' => 'リクエストしたデータを読み込めませんでした。',
	'flow-error-invalid-workflow' => 'リクエストしたワークフローが見つかりませんでした。',
	'flow-error-process-data' => 'リクエストのデータを処理する際にエラーが発生しました。',
...
$messages['vi'] = array(
	...
	'flow-topic-comments' => '{{PLURAL:$1|Bình luận ($1)|0={{GENDER:$2}}Hãy là người đầu tiên bình luận!}}',
