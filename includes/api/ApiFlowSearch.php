...
class ApiFlowSearch extends ApiFlowBaseGet {
	...
	public function execute() {
		...
		$rows = $this->query->getResults( $this->searchEngine, $params['term'] );
	...
	public function getAllowedParams() {
		...
		return array(
			...
			'type' => array(
				...
				ApiBase::PARAM_TYPE => array_merge( Connection::getAllIndexTypes(), array( false ) ),
	...
	public function getParamDescription() {
		...
		return array(
			...
			'type' => 'Desired type of results (' . implode( '|', Connection::getAllIndexTypes() ) . ')',
