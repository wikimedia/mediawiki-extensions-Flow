...
$wgResourceModules += array(
	...
	'ext.flow.moderation' => $flowResourceTemplate + array(
		...
		'messages' => array(
			...
			'flow-moderation-intro-censor-post',
			...
			'flow-moderation-confirmation-censor-topic',
