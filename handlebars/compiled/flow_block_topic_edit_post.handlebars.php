...
' : '').'
	...
	<div class="flow-form-actions flow-form-collapsible">
		<button class="flow-ui-button flow-ui-constructive"
		        data-flow-api-handler="submitEditPost">'.LCRun3::ch($cx, 'l10n', Array('flow-post-action-edit-post',((is_array($in) && isset($in['author'])) ? $in['author'] : null)), 'encq').'</button>
		<button class="flow-ui-button flow-ui-progressive flow-ui-quiet"
		        data-flow-api-handler="preview"
				name="preview" data-role="action">'.LCRun3::ch($cx, 'l10n', Array('flow-preview'), 'encq').'</button>
