...
TEXT
        ...
        function processOptions() {
		        ...
		        require_once $maintPath . '$IP/extensions/Flow/maintenance/backupPrefetch.inc';
	...
	function getFlowText( $id ) {
		...
		// FIXME how do we set this?? we want to get an AbstractRevision object based on the UUID. So?
		$revision = null;
