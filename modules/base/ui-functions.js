( function ( $, mw ) {
	$.fn.extend( true, {
		...
		'_flow' : {
			 ...
			 * @param {Object Literal} The key specifies the content identifier in the form and value is output format
			 */
			'setupPreview': function( contents ) {
				var $form = this, api = new mw.Api(), $previewContainer = $( '<div>' ).addClass( 'flow-content-preview' );
