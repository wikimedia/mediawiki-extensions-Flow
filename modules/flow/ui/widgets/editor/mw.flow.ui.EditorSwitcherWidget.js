...
console.log( 'switch editor', editorKey, editor );
	 ...
	 *
	 * @param {[type]} editorKey [description]
	...
	mw.flow.ui.EditorSwitcherWidget.prototype.setEditor = function ( editor, content ) {
		...
		// TODO: Add 'in progress' to the active editor
		...
		return this.setActiveEditor( editor )
			...
			.always( function () {
				// TODO: Remove the 'in progress' indication
