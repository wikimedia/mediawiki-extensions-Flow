...
class FlowHooks {
	...
	public static function getSchemaUpdates( DatabaseUpdater $updater ) {
		...
		require_once __DIR__.'/.maintenance/FlowUpdateWorkflowsForContentHandler.php';
		$updater->addPostDatabaseUpdateMaintenance( 'FlowUpdateWorkflowsForContentHandler.php' );
