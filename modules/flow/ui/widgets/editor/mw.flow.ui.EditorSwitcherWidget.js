( function ( $ ) {
	 ...
	 *   content (if any)
	 * @cfg {boolean} [collapsed=false] Set the widget's initial loading state to be
	 *  collapsed. Otherwise, the widget will immediately initialize an editor.
	 */
	mw.flow.ui.EditorSwitcherWidget = function mwFlowUiEditorSwitcherWidget( config ) {
		...
		// Do need to keep an input here for pending state though
		this.triggerInput.$input
			.on( 'focusin', this.toggleCollapsed.bind( this, false ) );
