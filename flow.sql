...
CREATE UNIQUE INDEX /*i*/flow_wiki_ref_pk ON /*_*/flow_wiki_ref
	(ref_src_workflow_id, ref_type, ref_target_namespace, ref_target_title, ref_src_object_id);

CREATE UNIQUE INDEX /*i*/flow_wiki_ref_revision ON /*_*/flow_wiki_ref
	(ref_src_workflow_id, ref_src_object_id, ref_type, ref_target_namespace, ref_target_title);
...
CREATE UNIQUE INDEX /*i*/flow_ext_ref_pk ON /*_*/flow_ext_ref
	(ref_src_workflow_id, ref_type, ref_target, ref_src_object_id);

CREATE UNIQUE INDEX /*i*/flow_ext_ref_revision ON /*_*/flow_ext_ref
	(ref_src_workflow_id, ref_src_object_id, ref_type, ref_target);
