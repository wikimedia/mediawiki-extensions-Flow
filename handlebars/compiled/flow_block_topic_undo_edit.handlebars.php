...
' : '').'
	<form method="POST" action="'.LR::encq($cx, ((isset($in['links']['undo-edit-post']) && is_array($in['links']['undo-edit-post']) && isset($in['links']['undo-edit-post']['url'])) ? $in['links']['undo-edit-post']['url'] : null)).'" class="flow-post" data-module="topic">
