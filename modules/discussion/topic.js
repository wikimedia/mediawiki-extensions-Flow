( function ( $, mw ) {
	...
	// using new to extend parent would actully invoke a call to the parent constructor, we would
	// want to avoid that because there is no topic object to pass to
