...
abstract class AbstractRevision {
	 ...
	 * @param bool $includeContent If false, do not load content; 'rev_content' will be null
	 * @return string[]
	 */
	public static function toStorageRow( $obj, $includeContent = true ) {
		return [
			...
			'rev_content' => $includeContent ? $obj->getLoadedContent() : null,
