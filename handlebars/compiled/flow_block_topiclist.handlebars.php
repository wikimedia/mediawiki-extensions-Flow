...
';},'flow_board_navigation' => function ($cx, $in) {return '
<div class="flow-board-navigation">
	...
	<div class="flow-board-navigation-inner">
		'.LCRun3::hbch($cx, 'progressiveEnhancement', Array(Array(),Array()), $in, function($cx, $in) {return '
			'.LCRun3::p($cx, 'flow_board_collapsers_subcomponent', Array(Array($in),Array())).'
		';}).'
