<?php return function ($in, $debugopt = 1) {
	...
	<div class="flow-form-actions flow-form-collapsible">
		<button data-role="submit" class="flow-ui-button flow-ui-constructive">'.LCRun3::ch($cx, 'l10n', Array('Edit',((is_array($in) && isset($in['author'])) ? $in['author'] : null)), 'encq').'</button>
		...
		<small class="flow-terms-of-use plainlinks">'.LCRun3::ch($cx, 'l10n', Array('edit_TOU'), 'encq').'</small>
	</div>
</form>
