	...
	( function () {
		...
		FlowBoardComponent.UI.events.apiHandlers.closeOpenTopic = function ( info, data, jqhxr ) {
			...
			flowBoard.API.apiCall( {
				...
				var result = result.flow['view-topic'].result.topic;
		...
		FlowBoardComponent.UI.events.apiHandlers.activateSummarizeTopic = function ( info, data, jqxhr ) {
			...
			if ( info.status !== 'done' ) {
				FlowBoardComponent.UI.showError( $node, jqxhr.error.info );
				return;
			}
		...
		FlowBoardComponent.UI.events.apiHandlers.activateEditPost = function ( info, data, jqxhr ) {
			...
			if ( info.status !== 'done' ) {
				FlowBoardComponent.UI.showError( $post, jqxhr.error.info );
				return;
			}
