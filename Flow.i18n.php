...
$messages['en'] = array(
	...
	'flow-newtopic-title-placeholder' => 'New topic or question',
	...
	'flow-newtopic-start-placeholder' => 'Start a new discussion',
	...
	'flow-topic-participants' => '{{PLURAL:$1|$3 started this topic|{{GENDER:$3|$3}}, {{GENDER:$4|$4}}, {{GENDER:$5|$5}} and {{PLURAL:$2|other|others}}|0=No participation yet|2={{GENDER:$3|$3}} and {{GENDER:$4|$4}}|3={{GENDER:$3|$3}}, {{GENDER:$4|$4}} and {{GENDER:$5|$5}}}}',
	...
	// Moderation dialog
	'flow-moderation-title-censor' => 'Suppress post?',
	'flow-moderation-title-delete' => 'Delete post?',
	'flow-moderation-title-hide'   => 'Hide post?',
	'flow-moderation-title-restore'=> 'Restore post?',
	'flow-moderation-intro-censor' => "Please explain why you're suppressing this post.",
	'flow-moderation-intro-delete' => "Please explain why you're deleting this post.",
	'flow-moderation-intro-hide'   => "Please explain why you're hiding this post.",
	'flow-moderation-intro-restore'=> "Please explain why you're restoring this post.",
	'flow-moderation-confirm-censor' => 'Suppress',
	'flow-moderation-confirm-delete' => 'Delete',
	'flow-moderation-confirm-hide' => 'Hide',
	'flow-moderation-confirm-restore' => 'Restore',
	'flow-moderation-confirmation-censor' => 'Consider giving $1 feedback on this post.',
	'flow-moderation-confirmation-delete' => 'Consider giving $1 feedback on this post.',
	'flow-moderation-confirmation-hide' => 'Consider giving $1 feedback on this post.',
	'flow-moderation-confirmation-restore' => 'Consider giving $1 feedback on this post.',
...
** {{msg-mw|Yesterday-at}}, {{msg-mw|Today-at}}
{{Related|Flow-post-by}}',
	'flow-post-censored' => 'Used as username/content if the post was suppressed.
...
{{Identical|History}}',
	'flow-moderation-title-censor' => 'Title for the moderation confirmation dialog when a post is being suppresseded.
...
$messages['de'] = array(
	...
	'logentry-suppress-flow-censor-post' => '$1 {{GENDER:$2|unterdrückte}} einen [$4 Kommentar] auf [[$3]]',
	'logentry-suppress-flow-restore-post' => '$1 {{GENDER:$2|löschte}} einen [$4 Kommentar] auf [[$3]]',
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|bearbeitete}} den Thementitel zu [$2 $3].',
...
$messages['fr'] = array(
	...
	'logentry-suppress-flow-censor-post' => '$1 {{GENDER:$2|a effacé}} un [$4 commentaire] sur [[$3]]',
	'logentry-suppress-flow-restore-post' => '$1 {{GENDER:$2|a supprimé}} un [$4 commentaire] sur [[$3]]',
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|a modifié}} le titre du sujet de [$2 $3].',
...
$messages['it'] = array(
	...
	'logentry-suppress-flow-censor-post' => '$1 {{GENDER:$2|ha soppresso}} un [$4 commento] su [[$3]]',
	'logentry-suppress-flow-restore-post' => '$1 {{GENDER:$2|ha cancellato}} un [$4 commento] su [[$3]]',
...
$messages['ja'] = array(
	...
	'logentry-suppress-flow-restore-post' => '$1 が [[$3]] の[$4 コメント]を{{GENDER:$2|削除}}',
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] が話題の名前を [$2 $3] に{{GENDER:$1|編集}}',
...
$messages['lb'] = array(
	'flow-desc' => 'Workflow-Management-System',
	'logentry-delete-flow-delete-post' => '$1 {{GENDER:$2|huet}} eng [$4 Bemierkung] op [[$3]] geläscht',
	'flow-user-anonymous' => 'Anonym',
...
$messages['mk'] = array(
	...
	'logentry-suppress-flow-censor-post' => '$1 {{GENDER:$2|скри}} [$4 коментар] на [[$3]]',
	'logentry-suppress-flow-restore-post' => '$1 {{GENDER:$2|избриша}} [$4 коментар] на [[$3]]',
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|го измени}} насловот на темата [$2 $3].',
...
$messages['uk'] = array(
	...
	'logentry-suppress-flow-censor-post' => '$1 {{GENDER:$2|подавив|подавила}} [$4 коментар] на [[$3]]',
	'logentry-suppress-flow-restore-post' => '$1 {{GENDER:$2|вилучив|вилучила}} [$4 коментар] на [[$3]]',
...
$messages['yi'] = array(
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|רעדאקטירט}} דעם טעמע טיטל צו [$2 $3].',
