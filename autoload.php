...
$wgAutoloadClasses['Flow\\Import\\Importer'] = dirname( __FILE__ ) . "/includes/Import/Importer.php";
$wgAutoloadClasses['Flow\\Import\\ImportSource'] = dirname( __FILE__ ) . "/includes/Import/ImportSource.php";
$wgAutoloadClasses['Flow\\Import\\ImportTopic'] = dirname( __FILE__ ) . "/includes/Import/ImportSource.php";
$wgAutoloadClasses['Flow\\Import\\ImportPost'] = dirname( __FILE__ ) . "/includes/Import/ImportSource.php";
$wgAutoloadClasses['Flow\\Import\\ImportSummary'] = dirname( __FILE__ ) . "/includes/Import/ImportSource.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportSource'] = dirname( __FILE__ ) . "/includes/Import/lqt-api/Source.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportTopic'] = dirname( __FILE__ ) . "/includes/Import/lqt-api/Objects.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportPost'] = dirname( __FILE__ ) . "/includes/Import/lqt-api/Objects.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportSummary'] = dirname( __FILE__ ) . "/includes/Import/lqt-api/Objects.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiTopicIterator'] = dirname( __FILE__ ) . "/includes/Import/lqt-api/Iterators.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiReplyIterator'] = dirname( __FILE__ ) . "/includes/Import/lqt-api/Iterators.php";
$wgAutoloadClasses['Flow\\Import\\CachedData'] = dirname( __FILE__ ) . "/includes/Import/CachedData.php";
$wgAutoloadClasses['Flow\\Import\\CachedApiData'] = dirname( __FILE__ ) . "/includes/Import/CachedData.php";
$wgAutoloadClasses['Flow\\Import\\CachedThreadData'] = dirname( __FILE__ ) . "/includes/Import/CachedData.php";
$wgAutoloadClasses['Flow\\Import\\CachedPageData'] = dirname( __FILE__ ) . "/includes/Import/CachedData.php";
