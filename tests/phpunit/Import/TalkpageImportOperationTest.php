...
class TalkpageImportOperationTest extends \MediaWikiTestCase {
	...
	public function testImportDoesntCompletelyFail() {
		...
		$op->import( new PageImportState( $workflow, $storage, $store ) );
		...
		// Seven objects should have been inserted in total
		$this->assertCount( 8, array_unique( $stored, SORT_REGULAR ) );
