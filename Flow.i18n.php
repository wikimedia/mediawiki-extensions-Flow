...
$messages['de'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|bearbeitete}} einen [$3 Kommentar].', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|fügte}} einen [$3 Kommentar] hinzu.', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2|erstellte}} die Boardüberschrift.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2|bearbeitete}} die Boardüberschrift.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|versteckte}} einen [$4 Kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2|löschte}} einen [$4 Kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2|unterdrückte}} einen [$4 Kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|stellte}} einen [$4 Kommentar] wieder her (<em>$5</em>).', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2|versteckte}} das [$4 Thema] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2|löschte}} das [$4 Thema] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 {{GENDER:$2|unterdrückte}} das [$4 Thema] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$2|stellte}} das [$4 Thema] wieder her (<em>$5</em>).', # Fuzzy
...
$messages['fa'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|ویرایش شد}} یک [$3 نظر].', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|اضافه شد}} یک [$3 نظر].', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2|ایجاد شد}} سرفصل صفحه.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2|وبرایش شد}} سرفصل صفحه.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|پنهان}} یک [$4 نظر] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2|حذف شد}} یک [$4 نظر] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2|سرکوب شد}} یک [$4 نظر] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|بازگردانده شد}} یک [$4 نظر] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2|پنهان شد}} [$4 موضوع] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2|حذف شد}} the [$4 موضوع] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 {{GENDER:$2|سرکوب شد}} the [$4موضوع] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$2|بازگردانده شد}} the [$4 موضوع] (<em>$5</em>).', # Fuzzy
...
$messages['fr'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|a modifié}} un [$3 commentaire].', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|a ajouté}} un [$3 commentaire].', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2|a créé}} l’entête du tableau.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2|a modifié}} l’entête du tableau.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|a masqué}} un [$4 commentaire] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2|a supprimé}} un [$4 commentaire] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2|a effacé}} un [$4 commentaire] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|a rétabli}} un [$4 commentaire] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2|a masqué}} le [$4 sujet] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2|a supprimé}} le [$4 sujet] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 {{GENDER:$2|a supprimé}} le [$4 sujet] (<em>$5</em>)..', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$2|a rétabli}} le [$4 sujet] (<em>$5</em>)..', # Fuzzy
...
$1',
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|ערך|ערכה}} [$3 תגובה].', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|הוסיף|הוסיפה}} [$3 תגובה].', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2|יצר|יצרה}} את תיאור הלוח.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2|ערך|ערכה}} את כותרת הלוח.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|הסתיר|הסתירה}} [$4 תגובה] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2|מחק|מחקה}} [$4 תגובה] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2|העלים|העלימה}} [$4 תגובה] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|שחזר|שחזרה}} [$4 תגובה] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2|הסתיר|הסתירה}} את [$4 הנושא] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2|מחק|מחקה}} את [$4 הנושא] (<em>$5</em>).', # Fuzzy
...
$messages['ja'] = array(
	...
	'flow-rev-message-edit-post' => '$1 が[$3 コメント]を{{GENDER:$2|編集}}', # Fuzzy
	'flow-rev-message-reply' => '$1 が[$3 コメント]を{{GENDER:$2|追加}}', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 が掲示板のヘッダーを{{GENDER:$2|作成}}', # Fuzzy
	'flow-rev-message-edit-header' => '$1 が掲示板のヘッダーを{{GENDER:$2|編集}}', # Fuzzy
	'flow-rev-message-hid-post' => '$1 が[$4 コメント]を{{GENDER:$2|非表示化}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 が[$4 コメント]を{{GENDER:$2|削除}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 が[$4 コメント]を{{GENDER:$2|秘匿}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-restored-post' => '$1 が[$4 コメント]を{{GENDER:$2|復元}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 が[$4 話題]を{{GENDER:$2|非表示化}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 が[$4 話題]を{{GENDER:$2|削除}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 が[$4 話題]を{{GENDER:$2|秘匿}} (<em>$5</em>)', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 が[$4 話題]を{{GENDER:$2|復元}} (<em>$5</em>)', # Fuzzy
...
$messages['lb'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|huet}} eng [$3 Bemierkung] geännert.', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|huet}} eng [$3 Bemierkung] derbäigesat.', # Fuzzy
	...
	'flow-rev-message-deleted-topic' => "$1 {{GENDER:$2|huet}} d'[Thema $4] (<em>$5</em>) geläscht.", # Fuzzy
...
$messages['mk'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|измени}} [$3 коментар].', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|доидаде}} [$3 коментар].', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2|го создаде}} заглавието на таблата.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2|го измени}} заглавието на таблата.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|скри}} [$4 коментар] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2|избриша}} [$4 коментар] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2|притаи}} [$4 коментар] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|поврати}} [$4 коментар] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2|ја скри}} [$4 темата] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2|ја избриша}} [$4 темата] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 {{GENDER:$2|ја притаи}} [$4 темата] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$2|ја поврати}} [$4 темата] (<em>$5</em>).', # Fuzzy
...
$messages['nl'] = array(
	...
	'flow-error-prev-revision-mismatch' => 'Een andere gebruiker bewerkte deze post al een paar seconden geleden. Weet u zeker dat u deze recente verandering wilt overschrijven?',
...
U kunt de andere versie van dit bericht bekijken op de [$6 geschiedenispagina].',
	...
	'flow-terms-of-use-new-topic' => 'Door te klikken op "{{int:flow-newtopic-save}}", gaat u akkoord met de gebruiksvoorwaarden van deze wiki.',
...
$messages['ru'] = array(
	...
	'flow-rev-message-edit-post' => '$1 отредактировал{{GENDER:$2||а}} [$3  комментарий].', # Fuzzy
	'flow-rev-message-reply' => '$1 добавил{{GENDER:$2||а}} [$3 комментарий].', # Fuzzy
	'flow-rev-message-new-post' => '$1 создал{{GENDER:$2||а}} тему [$3 $4].',
	'flow-rev-message-deleted-post' => '$1 удалил{{GENDER:$2||а}} [$4 комментарий] (<em>$5</em>).', # Fuzzy
...
$messages['sv'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2|redigerade}} en [$3 kommentar]', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2|lade till}} en [$3 kommentar].', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2|skapade}} forumets sidhuvud.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2|redigerade}} forumets sidhuvud.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2|dolde}} en [$4 kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2|raderade}} en [$4 kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2|censurerade}} en [$4 kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2|återställde}} en [$4 kommentar] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2|dolde}} [$4 ämnet] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2|tog bort}} [$4 ämnet] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 {{GENDER:$2|censurerade}} [$4 ämnet] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$2|återställde}} [$4 ämnet] (<em>$5</em>).', # Fuzzy
...
$messages['vi'] = array(
	...
	'flow-rev-message-edit-post' => '$1 {{GENDER:$2}}đã sửa đổi một [$3 bình luận].', # Fuzzy
	'flow-rev-message-reply' => '$1 {{GENDER:$2}}đã thêm một [$3 bình luận].', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1 {{GENDER:$2}}đã tạo đầu đề bảng tin nhắn.', # Fuzzy
	'flow-rev-message-edit-header' => '$1 {{GENDER:$2}}đã sửa đổi đầu đề bảng tin nhắn.', # Fuzzy
	'flow-rev-message-hid-post' => '$1 {{GENDER:$2}}đã ẩn một [$4 bình luận] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-post' => '$1 {{GENDER:$2}}đã xóa một [$4 bình luận] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1 {{GENDER:$2}}đã đàn áp một [$4 bình luận] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-post' => '$1 {{GENDER:$2}}đã phục hồi một [$4 bình luận] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-hid-topic' => '$1 {{GENDER:$2}}đã ẩn [$4 chủ đề] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1 {{GENDER:$2}}đã xóa [$4 chủ đề] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-suppressed-topic' => '$1 {{GENDER:$2}}đã đàn áp [$4 chủ đề] (<em>$5</em>).', # Fuzzy
	'flow-rev-message-restored-topic' => '$1 {{GENDER:$2}}đã phục hồi [$4 chủ đề] (<em>$5</em>).', # Fuzzy
...
$messages['zh-hans'] = array(
	...
	'flow-rev-message-edit-post' => '$1{{GENDER:$2|编辑了}}一个[$3 评论]。', # Fuzzy
	'flow-rev-message-reply' => '$1{{GENDER:$2|添加了}}一个[$3 评论]。', # Fuzzy
	...
	'flow-rev-message-create-header' => '$1{{GENDER:$2|创建了}}页顶。', # Fuzzy
	'flow-rev-message-edit-header' => '$1{{GENDER:$2|编辑了}}页顶。', # Fuzzy
	'flow-rev-message-hid-post' => '$1{{GENDER:$2|隐藏}}了一个[$4 评论]（<em>$5</em>）。', # Fuzzy
	'flow-rev-message-deleted-post' => '$1{{GENDER:$2|删除}}了[$4 评论]（<em>$5</em>）。', # Fuzzy
	'flow-rev-message-suppressed-post' => '$1{{GENDER:$2|抑制}}了一个[$4 评论]（<em>$5</em>）。', # Fuzzy
	'flow-rev-message-restored-post' => '$1{{GENDER:$2|恢复}}了一个[$4 评论]（<em>$5</em>）。', # Fuzzy
	'flow-rev-message-hid-topic' => '$1{{GENDER:$2|隐藏}}了一个[$4 主题]（<em>$5</em>）。', # Fuzzy
	'flow-rev-message-deleted-topic' => '$1{{GENDER:$2|删除}}了一个[$4 主题]（<em>$5</em>）。', # Fuzzy
