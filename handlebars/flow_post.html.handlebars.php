						...
						<div class="flow-menu">
							...
							<ul class="flow-ui-button-container">
								'.LCRun2::ifv(((is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null), $cx, $in, function($cx, $in) {return '
									<li><a class="flow-ui-button flow-ui-progressive flow-ui-quiet flow-ui-thin" href="'.LCRun2::enc(((is_array($in['actions']['lock']) && isset($in['actions']['lock']['url'])) ? $in['actions']['lock']['url'] : null), $cx).'" title="'.LCRun2::enc(((is_array($in['actions']['lock']) && isset($in['actions']['lock']['title'])) ? $in['actions']['lock']['title'] : null), $cx).'"><span class="WikiFont WikiFont-eye-lock"></span> '.LCRun2::ch('l10n', Array('Lock.'), 'enc', $cx).'</a></li>
								';}).'
