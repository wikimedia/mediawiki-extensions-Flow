( function ( $ ) {
	 ...
	 */
	mw.flow.ui.TopicMenuSelectWidget = function mwFlowUiTopicMenuSelectWidget( sustem, config ) {
		config = config || {};
	...
	mw.flow.ui.TopicMenuSelectWidget.prototype.getMoreTopics = function () {
		...
		this.system.fetchMoreTopics()
			.then( function ( isMoreTopicsExistInApi ) {
				widget.noMoreTopics = isMoreTopicsExistInApi;
