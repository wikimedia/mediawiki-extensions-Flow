...
'.$sp.'	          placeholder="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-moderation-placeholder-',(isset($cx['sp_vars']['root']['submitted']['moderationState']) ? $cx['sp_vars']['root']['submitted']['moderationState'] : null),'-topic'),array()), 'raw', $in)),array()), 'encq', $in)).'"
'.$sp.'	          autofocus'.((LR::ifvar($cx, (isset($cx['sp_vars']['root']['submitted']['reason']) ? $cx['sp_vars']['root']['submitted']['reason'] : null), false)) ? 'value="'.LR::encq($cx, (isset($cx['sp_vars']['root']['submitted']['reason']) ? $cx['sp_vars']['root']['submitted']['reason'] : null)).'"' : '').'>
...
'.$sp.'		        data-role="submit">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-moderation-confirm-',(isset($cx['sp_vars']['root']['submitted']['moderationState']) ? $cx['sp_vars']['root']['submitted']['moderationState'] : null),'-topic'),array()), 'raw', $in)),array()), 'encq', $in)).'</button>
'.$sp.'		<a class="mw-ui-button mw-ui-quiet mw-ui-destructive"
'.$sp.'		   href="'.LR::encq($cx, ((isset($in['links']['topic']) && is_array($in['links']['topic']) && isset($in['links']['topic']['url'])) ? $in['links']['topic']['url'] : null)).'"
'.$sp.'		   title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-cancel'),array()), 'encq', $in)).'"
'.$sp.'		   data-flow-interactive-handler="cancelForm">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-cancel'),array()), 'encq', $in)).'</a>
'.$sp.'	</div>
'.$sp.'</form>
';},
...
'.$sp.'</div>
';},
'flow_moderation_actions_list' => function ($cx, $in, $sp) {$inary=is_array($in);return ''.$sp.'<section>'.LR::hbbch($cx, 'ifCond', array(array((($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'===','topic'),array()), $in, false, function($cx, $in)use($sp){$inary=is_array($in);return ''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['edit'])) ? $in['actions']['edit'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-edit-title-link"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['edit']) && is_array($in['actions']['edit']) && isset($in['actions']['edit']['url'])) ? $in['actions']['edit']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-edit"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-topic-action-edit-title'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['topic-history'])) ? $in['links']['topic-history'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['links']['topic-history']) && is_array($in['links']['topic-history']) && isset($in['links']['topic-history']['url'])) ? $in['links']['topic-history']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-clock"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-topic-action-history'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['topic'])) ? $in['links']['topic'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['links']['topic']) && is_array($in['links']['topic']) && isset($in['links']['topic']['url'])) ? $in['links']['topic']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-link"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-topic-action-view'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['summarize'])) ? $in['actions']['summarize'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-summarize-topic-link"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['summarize']) && is_array($in['actions']['summarize']) && isset($in['actions']['summarize']['url'])) ? $in['actions']['summarize']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-listBullet"><span>' : '').''.((LR::ifvar($cx, ((isset($in['summary']['revision']['content']) && is_array($in['summary']['revision']['content']) && isset($in['summary']['revision']['content']['content'])) ? $in['summary']['revision']['content']['content'] : null), false)) ? ''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-topic-action-resummarize-topic'),array()), 'raw', $in)),array()), 'encq', $in)).'' : ''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-topic-action-summarize-topic'),array()), 'raw', $in)),array()), 'encq', $in)).'').''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').'';}).''.LR::hbbch($cx, 'ifCond', array(array((($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'===','history'),array()), $in, false, function($cx, $in)use($sp){$inary=is_array($in);return ''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-topicmenu-lock"
'.$sp.'				   data-role="lock"
'.$sp.'				   data-flow-id="'.LR::encq($cx, (($inary && isset($in['postId'])) ? $in['postId'] : null)).'"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['lock']) && is_array($in['actions']['lock']) && isset($in['actions']['lock']['url'])) ? $in['actions']['lock']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-check"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-lock-topic'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['unlock'])) ? $in['actions']['unlock'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-topicmenu-lock"
'.$sp.'				   data-role="unlock"
'.$sp.'				   data-flow-id="'.LR::encq($cx, (($inary && isset($in['postId'])) ? $in['postId'] : null)).'"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['unlock']) && is_array($in['actions']['unlock']) && isset($in['actions']['unlock']['url'])) ? $in['actions']['unlock']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-ongoingConversation"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-unlock-topic'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').'';}, function($cx, $in)use($sp){$inary=is_array($in);return ''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-topicmenu-lock"
'.$sp.'				   data-flow-id="'.LR::encq($cx, (($inary && isset($in['postId'])) ? $in['postId'] : null)).'"
'.$sp.'				   data-role="lock"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['lock']) && is_array($in['actions']['lock']) && isset($in['actions']['lock']['url'])) ? $in['actions']['lock']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-check"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-lock-topic'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['unlock'])) ? $in['actions']['unlock'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-topicmenu-lock"
'.$sp.'				   data-flow-id="'.LR::encq($cx, (($inary && isset($in['postId'])) ? $in['postId'] : null)).'"
'.$sp.'				   data-role="unlock"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['unlock']) && is_array($in['actions']['unlock']) && isset($in['actions']['unlock']['url'])) ? $in['actions']['unlock']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-ongoingConversation"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-unlock-topic'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').'';}).''.LR::hbbch($cx, 'ifCond', array(array((($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'===','post'),array()), $in, false, function($cx, $in)use($sp){$inary=is_array($in);return ''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['edit'])) ? $in['actions']['edit'] : null), false)) ? '<li>
'.$sp.'				<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet flow-ui-edit-post-link"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['actions']['edit']) && is_array($in['actions']['edit']) && isset($in['actions']['edit']['url'])) ? $in['actions']['edit']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-edit"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-post-action-edit-post'),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>
'.$sp.'			</li>' : '').''.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['post'])) ? $in['links']['post'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
'.$sp.'				   href="'.LR::encq($cx, ((isset($in['links']['post']) && is_array($in['links']['post']) && isset($in['links']['post']['url'])) ? $in['links']['post']['url'] : null)).'">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-link"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-post-action-view'),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').'';}).'</section>
'.$sp.'
...
'.$sp.'			   data-role="hide">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-flag"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-hide-',(($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['unhide'])) ? $in['actions']['unhide'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
...
'.$sp.'			   data-flow-interactive-handler="moderationDialog"
'.$sp.'			   data-flow-template="flow_moderate_'.LR::encq($cx, (($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)).'.partial"
'.$sp.'			   data-role="unhide">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-flag"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-unhide-',(($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['delete'])) ? $in['actions']['delete'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
...
'.$sp.'			   data-flow-interactive-handler="moderationDialog"
'.$sp.'			   data-flow-template="flow_moderate_'.LR::encq($cx, (($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)).'.partial"
'.$sp.'			   data-role="delete">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-trash"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-delete-',(($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['undelete'])) ? $in['actions']['undelete'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
...
'.$sp.'			   data-flow-interactive-handler="moderationDialog"
'.$sp.'			   data-flow-template="flow_moderate_'.LR::encq($cx, (($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)).'.partial"
'.$sp.'			   data-role="undelete">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-trash"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-undelete-',(($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['suppress'])) ? $in['actions']['suppress'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
...
'.$sp.'			   data-flow-interactive-handler="moderationDialog"
'.$sp.'			   data-flow-template="flow_moderate_'.LR::encq($cx, (($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)).'.partial"
'.$sp.'			   data-role="suppress">'.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-block"><span>' : '').''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-',(($inary && isset($in['moderationType'])) ? $in['moderationType'] : null),'-action-suppress-',(($inary && isset($in['moderationTemplate'])) ? $in['moderationTemplate'] : null)),array()), 'raw', $in)),array()), 'encq', $in)).''.((LR::ifvar($cx, (($inary && isset($in['moderationIcons'])) ? $in['moderationIcons'] : null), false)) ? '</span></span>' : '').'</a>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'</li>' : '').''.((LR::ifvar($cx, ((isset($in['actions']) && is_array($in['actions']) && isset($in['actions']['unsuppress'])) ? $in['actions']['unsuppress'] : null), false)) ? '<li>'.LR::encq($cx, (($inary && isset($in['noop'])) ? $in['noop'] : null)).'<a class="'.LR::encq($cx, (($inary && isset($in['moderationMwUiClass'])) ? $in['moderationMwUiClass'] : null)).' mw-ui-quiet"
...
'.LR::sec($cx, (($inary && isset($in['roots'])) ? $in['roots'] : null), null, $in, true, function($cx, $in) {$inary=is_array($in);return ''.LR::hbbch($cx, 'eachPost', array(array((isset($cx['sp_vars']['root']) ? $cx['sp_vars']['root'] : null),$in),array()), $in, false, function($cx, $in) {$inary=is_array($in);return ''.LR::p($cx, 'flow_moderate_topic', array(array($in),array()),0, '			').''.LR::p($cx, 'flow_post_partial', array(array($in),array()),0, '			').'';}).'';}).'</div>
';
};