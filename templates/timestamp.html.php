<?php echo Html::openElement( isset( $tag ) ? $tag : 'p', array( 'class' => 'flow-datestamp' ) ); ?>
	...
	<?php } ?>
		<span class="flow-agotime"><?php echo htmlspecialchars( $timestamp->getHumanTimestamp() ); ?></span>
		<span class="flow-utctime"><?php echo htmlspecialchars( $timestamp->getTimestamp( TS_RFC2822 ) ); ?></span>
