...
ALTER TABLE /*_*/flow_revision ADD rev_mod_user_wiki varchar(32) binary not null;

ALTER TABLE /*_*/flow_revision ADD rev_edit_user_wiki varchar(32) binary not null;
