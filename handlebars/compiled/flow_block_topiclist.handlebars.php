...
'.$sp.''.LR::hbch($cx, 'tooltip', array(array(),array('positionClass'=>'down','contextClass'=>'progressive','extraClass'=>'flow-form-collapsible','isBlock'=>true)), $in, false, function($cx, $in)use($sp){return ''.LR::encq($cx, LR::hbch($cx, 'l10nParse', array(array('flow-anon-warning',LR::hbch($cx, 'linkWithReturnTo', array(array('Special:UserLogin'),array()), 'raw', $in),LR::hbch($cx, 'linkWithReturnTo', array(array('Special:UserLogin/signup'),array()), 'raw', $in)),array()), 'encq', $in)).'';}).'	</div>
'.$sp.'
...
'.$sp.''.LR::hbch($cx, 'tooltip', array(array(),array('positionClass'=>'left','contextClass'=>'progressive','extraClass'=>'flow-form-collapsible','isBlock'=>true)), $in, false, function($cx, $in)use($sp){return ''.LR::encq($cx, LR::hbch($cx, 'l10nParse', array(array('flow-anon-warning',LR::hbch($cx, 'linkWithReturnTo', array(array('Special:UserLogin'),array()), 'raw', $in),LR::hbch($cx, 'linkWithReturnTo', array(array('Special:UserLogin/signup'),array()), 'raw', $in)),array()), 'encq', $in)).'';}).'		</div>
'.$sp.'';}).'</div>
';},
...
'.$sp.'
'.$sp.'>
'.$sp.''.((LR::ifvar($cx, ((isset($in['msg']) && is_array($in)) ? $in['msg'] : null), false)) ? ''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(((isset($in['msg']) && is_array($in)) ? $in['msg'] : null)),array()), 'encq', $in)).'' : ''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-cancel'),array()), 'encq', $in)).'').'</button>
';},
...
'.$sp.'			          placeholder="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-newtopic-content-placeholder',((isset($cx['sp_vars']['root']['title']) && is_array($cx['sp_vars']['root'])) ? $cx['sp_vars']['root']['title'] : null)),array()), 'encq', $in)).'"
...
'.$sp.'				class="mw-ui-button mw-ui-constructive mw-ui-flush-right">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-newtopic-save'),array()), 'encq', $in)).'</button>
'.$sp.''.LR::p($cx, 'flow_form_cancel_button', array(array($in),array()), '			').'			<small class="flow-terms-of-use plainlinks">'.LR::encq($cx, LR::hbch($cx, 'l10nParse', array(array('flow-terms-of-use-new-topic'),array()), 'encq', $in)).'</small>
'.$sp.'		</div>
'.$sp.'	</form>
'.$sp.'' : '').'';},
...
';},
'flow_post_moderation_state' => function ($cx, $in, $sp) {return ''.$sp.'<span class="plainlinks">'.((LR::ifvar($cx, ((isset($in['replyToId']) && is_array($in)) ? $in['replyToId'] : null), false)) ? ''.LR::encq($cx, LR::hbch($cx, 'l10nParse', array(array(LR::hbch($cx, 'concat', array(array('flow-',((isset($in['moderateState']) && is_array($in)) ? $in['moderateState'] : null),'-post-content'),array()), 'raw', $in),((isset($in['moderator']['name']) && is_array($in['moderator'])) ? $in['moderator']['name'] : null),((isset($in['links']['topic-history']['url']) && is_array($in['links']['topic-history'])) ? $in['links']['topic-history']['url'] : null)),array()), 'encq', $in)).'' : ''.LR::encq($cx, LR::hbch($cx, 'l10nParse', array(array(LR::hbch($cx, 'concat', array(array('flow-',((isset($in['moderateState']) && is_array($in)) ? $in['moderateState'] : null),'-title-content'),array()), 'raw', $in),((isset($in['moderator']['name']) && is_array($in['moderator'])) ? $in['moderator']['name'] : null),((isset($in['links']['topic-history']['url']) && is_array($in['links']['topic-history'])) ? $in['links']['topic-history']['url'] : null)),array()), 'encq', $in)).'').'</span>
';},
...
'.$sp.'' : '').'            >
'.$sp.'		'.((LR::ifvar($cx, ((isset($in['isLocked']) && is_array($in)) ? $in['isLocked'] : null), false)) ? '<span class="mw-ui-icon mw-ui-icon-before mw-ui-icon-check"></span> ' : '').''.LR::encq($cx, LR::hbch($cx, 'escapeContent', array(array(((isset($in['content']['format']) && is_array($in['content'])) ? $in['content']['format'] : null),((isset($in['content']['content']) && is_array($in['content'])) ? $in['content']['content'] : null)),array()), 'encq', $in)).'</h2>
...
'.$sp.'               title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-show-comments-title',((isset($in['reply_count']) && is_array($in)) ? $in['reply_count'] : null)),array()), 'encq', $in)).'"
'.$sp.'               data-collapsed-title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-show-comments-title',((isset($in['reply_count']) && is_array($in)) ? $in['reply_count'] : null)),array()), 'encq', $in)).'"
'.$sp.'               data-expanded-title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-hide-comments-title',((isset($in['reply_count']) && is_array($in)) ? $in['reply_count'] : null)),array()), 'encq', $in)).'"
'.$sp.'               data-flow-interactive-handler="collapserCollapsibleToggle"
'.$sp.'                    >'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-topic-comments',((isset($in['reply_count']) && is_array($in)) ? $in['reply_count'] : null)),array()), 'encq', $in)).'</a>' : ''.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-topic-comments',((isset($in['reply_count']) && is_array($in)) ? $in['reply_count'] : null)),array()), 'encq', $in)).'').' &bull;
'.$sp.'
...
'.$sp.''.((LR::ifvar($cx, ((isset($in['last_updated']) && is_array($in)) ? $in['last_updated'] : null), false)) ? '				'.LR::encq($cx, LR::hbch($cx, 'timestamp', array(array(((isset($in['last_updated']) && is_array($in)) ? $in['last_updated'] : null)),array()), 'encq', $in)).'
'.$sp.'' : '				'.LR::encq($cx, LR::hbch($cx, 'uuidTimestamp', array(array(((isset($in['postId']) && is_array($in)) ? $in['postId'] : null)),array()), 'encq', $in)).'
'.$sp.'').'        </a>
'.$sp.'    </div>
...
'.$sp.'			'.LR::encq($cx, LR::hbch($cx, 'escapeContent', array(array(((isset($in['moderateReason']['format']) && is_array($in['moderateReason'])) ? $in['moderateReason']['format'] : null),((isset($in['moderateReason']['content']) && is_array($in['moderateReason'])) ? $in['moderateReason']['content'] : null)),array()), 'encq', $in)).'
'.$sp.'        </div>
...
'.$sp.''.LR::hbch($cx, 'ifCond', array(array(((isset($in['revision']['creator']['name']) && is_array($in['revision']['creator'])) ? $in['revision']['creator']['name'] : null),'===',((isset($in['revision']['author']['name']) && is_array($in['revision']['author'])) ? $in['revision']['author']['name'] : null)),array()), $in, false, function($cx, $in)use($sp){return '					'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-summary-authored',((isset($in['revision']['creator']['name']) && is_array($in['revision']['creator'])) ? $in['revision']['creator']['name'] : null)),array()), 'encq', $in)).'
'.$sp.'';}, function($cx, $in)use($sp){return '					'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-summary-edited',((isset($in['revision']['author']['name']) && is_array($in['revision']['author'])) ? $in['revision']['author']['name'] : null)),array()), 'encq', $in)).'
'.$sp.'					<a href="'.LR::encq($cx, ((isset($in['revision']['links']['diff-prev']['url']) && is_array($in['revision']['links']['diff-prev'])) ? $in['revision']['links']['diff-prev']['url'] : null)).'" class="flow-timestamp-anchor">'.LR::encq($cx, LR::hbch($cx, 'uuidTimestamp', array(array(((isset($in['revision']['lastEditId']) && is_array($in['revision'])) ? $in['revision']['lastEditId'] : null)),array()), 'encq', $in)).'</a>
'.$sp.'';}).'			</div>
'.$sp.'			<div class="flow-topic-summary-content">
'.$sp.'				'.LR::encq($cx, LR::hbch($cx, 'escapeContent', array(array(((isset($in['revision']['content']['format']) && is_array($in['revision']['content'])) ? $in['revision']['content']['format'] : null),((isset($in['revision']['content']['content']) && is_array($in['revision']['content'])) ? $in['revision']['content']['content'] : null)),array()), 'encq', $in)).'
'.$sp.'			</div>
...
'.$sp.'	   data-flow-api-method="POST">'.LR::encq($cx, ((isset($in['noop']) && is_array($in)) ? $in['noop'] : null)).'<span class="flow-unwatch mw-ui-icon mw-ui-icon-before mw-ui-icon-unStar-constructive" title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-topic-action-watchlist-remove'),array()), 'encq', $in)).'"></span>'.LR::encq($cx, ((isset($in['noop']) && is_array($in)) ? $in['noop'] : null)).''.LR::encq($cx, ((isset($in['noop']) && is_array($in)) ? $in['noop'] : null)).'<span class="flow-watch mw-ui-icon mw-ui-icon-before mw-ui-icon-star mw-ui-icon-star-constructive-hover" title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-topic-action-watchlist-add'),array()), 'encq', $in)).'"></span>'.LR::encq($cx, ((isset($in['noop']) && is_array($in)) ? $in['noop'] : null)).'</a>
'.$sp.'</div>
';},
...
'.$sp.'		          type="text"
'.$sp.'			          placeholder="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-reply-topic-title-placeholder',((isset($in['properties']['topic-of-post-text-from-html']) && is_array($in['properties'])) ? $in['properties']['topic-of-post-text-from-html'] : null)),array()), 'encq', $in)).'"
'.$sp.'		          data-role="content"
'.$sp.'
...
'.$sp.''.LR::p($cx, 'flow_form_cancel_button', array(array($in),array()), '		').'		<small class="flow-terms-of-use plainlinks">'.LR::encq($cx, LR::hbch($cx, 'l10nParse', array(array('flow-terms-of-use-reply'),array()), 'encq', $in)).'</small>
'.$sp.'	</div>
'.$sp.'</form>
'.$sp.'' : '').'';},
...
'.$sp.'				'.LR::encq($cx, LR::hbch($cx, 'post', array(array(((isset($cx['sp_vars']['root']) && is_array($cx['sp_vars'])) ? $cx['sp_vars']['root'] : null),$in),array()), 'encq', $in)).'
'.$sp.'';}).'';}).'' : '').'
...
'.$sp.'			>'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-reply-topic-title-placeholder',((isset($in['properties']['topic-of-post-text-from-html']) && is_array($in['properties'])) ? $in['properties']['topic-of-post-text-from-html'] : null)),array()), 'encq', $in)).'</a>
	...
	<div class="flow-newtopic-container">
		<div class="flow-nojs">
			<a class="mw-ui-input mw-ui-input-large flow-ui-input-replacement-anchor"
				href="'.LR::encq($cx, ((isset($in['links']['newtopic']) && is_array($in['links'])) ? $in['links']['newtopic'] : null)).'">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-newtopic-start-placeholder'),array()), 'encq', $in)).'</a>
		</div>
