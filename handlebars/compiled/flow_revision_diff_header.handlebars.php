use \LightnCandy\SafeString as SafeString;use \LightnCandy\Runtime as LR;return function ($in = null, $options = null) {
    ...
    $partials = array('flow_patrol_diff' => function ($cx, $in, $sp) {return ''.$sp.''.((LR::ifvar($cx, ((isset($in['revision']['rev_view_links']) && is_array($in['revision']['rev_view_links']) && isset($in['revision']['rev_view_links']['markPatrolled'])) ? $in['revision']['rev_view_links']['markPatrolled'] : null), false)) ? '<div>
...
'.((LR::ifvar($cx, ((is_array($in) && isset($in['new'])) ? $in['new'] : null), false)) ? ''.((LR::ifvar($cx, ((isset($in['revision']['actions']) && is_array($in['revision']['actions']) && isset($in['revision']['actions']['undo'])) ? $in['revision']['actions']['undo'] : null), false)) ? '('.LR::encq($cx, ((is_array($in) && isset($in['noop'])) ? $in['noop'] : null)).'<a class="mw-ui-anchor mw-ui-quiet" href="'.LR::encq($cx, ((isset($in['revision']['actions']['undo']) && is_array($in['revision']['actions']['undo']) && isset($in['revision']['actions']['undo']['url'])) ? $in['revision']['actions']['undo']['url'] : null)).'">'.LR::encq($cx, ((isset($in['revision']['actions']['undo']) && is_array($in['revision']['actions']['undo']) && isset($in['revision']['actions']['undo']['title'])) ? $in['revision']['actions']['undo']['title'] : null)).'</a>'.LR::encq($cx, ((is_array($in) && isset($in['noop'])) ? $in['noop'] : null)).')' : '').'' : '').'</div>
'.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['previous'])) ? $in['links']['previous'] : null), false)) ? ''.((!LR::ifvar($cx, ((is_array($in) && isset($in['new'])) ? $in['new'] : null), false)) ? '<div><a href="'.LR::encq($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['previous'])) ? $in['links']['previous'] : null)).'">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-previous-diff'),array()), 'encq', $in)).'</a></div>' : '').'' : '').''.((LR::ifvar($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['next'])) ? $in['links']['next'] : null), false)) ? ''.((LR::ifvar($cx, ((is_array($in) && isset($in['new'])) ? $in['new'] : null), false)) ? '<div><a href="'.LR::encq($cx, ((isset($in['links']) && is_array($in['links']) && isset($in['links']['next'])) ? $in['links']['next'] : null)).'">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-next-diff'),array()), 'encq', $in)).'</a></div>' : '').'' : '').''.LR::p($cx, 'flow_patrol_diff', array(array($in),array()),0).'';
};