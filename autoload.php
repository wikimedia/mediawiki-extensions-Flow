...
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportSource'] = dirname( __FILE__ ) . "/includes/Import/LiquidThreadsApi.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportTopic'] = dirname( __FILE__ ) . "/includes/Import/LiquidThreadsApi.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportPost'] = dirname( __FILE__ ) . "/includes/Import/LiquidThreadsApi.php";
$wgAutoloadClasses['Flow\\Import\\LiquidThreadsApiImportSummary'] = dirname( __FILE__ ) . "/includes/Import/LiquidThreadsApi.php";
