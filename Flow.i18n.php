...
"this item" seems to refer "this post".',
	...
	'flow-rev-message-reply' => 'Used as a revision comment when a new reply has been posted. Parameters:
* $1: Username of the user who replied. Can be used for GENDER
* $2: The url of the post',
	'flow-rev-message-reply-bundle' => "When multiple replies have been posted, they're bundled. This is the message to describe that multiple replies were posted. Parameters:
* $1: The amount of replies posted",
	...
	'flow-rev-message-edit-title' => "Used as revision comment when a post has been edited. Parameters:
