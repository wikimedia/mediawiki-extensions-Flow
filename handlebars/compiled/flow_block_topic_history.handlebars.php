<?php return function ($in, $debugopt = 1) {
	...
	<div class="flow-board-link plainlinks">
		'.LCRun3::ch($cx, 'l10nParse', Array(Array('flow-history-pages-topic',((is_array($in['board']) && isset($in['board']['link'])) ? $in['board']['link'] : null),((is_array($in['board']) && isset($in['board']['title_text'])) ? $in['board']['title_text'] : null)),Array()), 'encq').'
	</div>
