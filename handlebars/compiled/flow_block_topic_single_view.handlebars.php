...
'.$sp.'' : '').'</div>
';},
'flow_patrol_action' => function ($cx, $in, $sp) {return ''.$sp.''.((LR::ifvar($cx, ((isset($in['revision']['rev_view_links']) && is_array($in['revision']['rev_view_links']) && isset($in['revision']['rev_view_links']['markPatrolled'])) ? $in['revision']['rev_view_links']['markPatrolled'] : null), false)) ? '<div class="patrollink" data-mw="interface">
