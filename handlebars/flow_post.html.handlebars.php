						...
						<div class="flow-menu">
							...
							<ul class="flow-ui-button-container">
								'.LCRun2::ifv(((is_array($in['actions']) && isset($in['actions']['hide'])) ? $in['actions']['hide'] : null), $cx, $in, function($cx, $in) {return '
									<li><a class="flow-ui-button flow-ui-quiet flow-ui-thin" href="'.LCRun2::enc(((is_array($in['actions']['actions']) && isset($in['actions']['actions']['hide'])) ? $in['actions']['actions']['hide'] : null), $cx).'"><span class="WikiFont WikiFont-eye-lid"></span> '.LCRun2::ch('l10n', Array('Hide'), 'enc', $cx).'</a></li>
								';}).'
