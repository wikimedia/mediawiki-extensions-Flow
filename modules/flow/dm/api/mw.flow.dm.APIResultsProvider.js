 ...
 */
mw.flow.dm.APIResultsProvider = function FlowDmAPIResultsProvider( apiurl, config ) {
	config = config || {};
 ...
 * of available results, or an empty array if there are no more results.
 */
...
mw.flow.dm.APIResultsProvider.prototype.setUserParams = function ( params ) {
	// Compare to make sure that there are changes in the
	// paremeters given, considering it is a subset of the
	// existing userParams
