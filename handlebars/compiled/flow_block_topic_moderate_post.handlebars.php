...
'.$sp.'	          placeholder="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-moderation-placeholder-',(isset($cx['sp_vars']['root']['submitted']['moderationState']) ? $cx['sp_vars']['root']['submitted']['moderationState'] : null),'-post'),array()), 'raw', $in)),array()), 'encq', $in)).'"
...
'.$sp.'		        data-role="submit">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array(LR::hbch($cx, 'concat', array(array('flow-moderation-confirm-',(isset($cx['sp_vars']['root']['submitted']['moderationState']) ? $cx['sp_vars']['root']['submitted']['moderationState'] : null),'-post'),array()), 'raw', $in)),array()), 'encq', $in)).'</button>
...
'.$sp.'		   title="'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-cancel'),array()), 'encq', $in)).'">'.LR::encq($cx, LR::hbch($cx, 'l10n', array(array('flow-cancel'),array()), 'encq', $in)).'</a>
'.$sp.'	</div>
'.$sp.'</form>
';},
...
'.LR::hbbch($cx, 'eachPost', array(array((isset($cx['sp_vars']['root']) ? $cx['sp_vars']['root'] : null),(isset($cx['sp_vars']['root']['submitted']['postId']) ? $cx['sp_vars']['root']['submitted']['postId'] : null)),array()), $in, false, function($cx, $in) {$inary=is_array($in);return ''.LR::p($cx, 'flow_moderate_post', array(array($in),array()),0, '		').''.LR::p($cx, 'flow_post_partial', array(array($in),array()),0, '		').'';}).'</div>
';
};