    ...
    return '					
					<div class="flow-board-navigation">
						...
						<div>
							...
							'.LCRun2::enc(((is_array($in) && isset($in['progressiveEnhancement'])) ? $in['progressiveEnhancement'] : null), $cx).'
					...
					<div class="flow-board">
						...
						<textarea id="flow-post-'.LCRun2::enc(((is_array($in) && isset($in['id'])) ? $in['id'] : null), $cx).'-form-content" data-flow-expandable="true" class="mw-ui-input" type="text" placeholder="'.LCRun2::ch('l10n', Array('Reply_to_author_name',((is_array($in) && isset($in['author'])) ? $in['author'] : null)), 'enc', $cx).'" required="required"></textarea>
