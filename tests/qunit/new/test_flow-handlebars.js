...
QUnit.test( 'Handlebars.prototype.ifCond', 8, function( assert ) {
	assert.strictEqual( this.handlebarsProto.ifCond( 'foo', 'equalTo', 'bar', this.opts ), 'nope', 'not equal' );
	assert.strictEqual( this.handlebarsProto.ifCond( 'foo', 'equalTo', 'foo', this.opts ), 'ok', 'equal' );
	...
	assert.strictEqual( this.handlebarsProto.ifCond( 'foo', 'notEqualTo', 'foo', this.opts ), 'nope' );
	assert.strictEqual( this.handlebarsProto.ifCond( 'foo', 'notEqualTo', 'bar', this.opts ), 'ok' );
} );
