...
class TopicUpdater extends Updater {
	 ...
	 */
	protected function buildDocumentForRevision( /* PostRevision */ $revision, $flags ) {
		...
		$doc = new \Elastica\Document(
			...
			array(
				...
				'title' => $revision->getContent( 'wikitext' ), // title doesn't contain parseable text
	 ...
	 * @return array
	 */
	protected function getRevisionContent( PostRevision $revision, array $result ) {
