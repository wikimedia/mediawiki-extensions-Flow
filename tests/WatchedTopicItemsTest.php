...
class WatchedTopicItemTest extends FlowTestCase {
	...
	public function testGetWatchStatus( $uuids, $dbResult, $result ) {
		$watchedTopicItems = new WatchedTopicItems( User::newFromName( 'test', false ), $this->mockDbFactory( $dbResult ) );
		...
		$watchedTopicItems = new WatchedTopicItems( User::newFromId( 0 ), $this->mockDbFactory( $dbResult ) );
