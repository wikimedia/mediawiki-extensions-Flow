...
';}).'
	...
	<div class="flow-form-actions flow-form-collapsible">
		...
		<button data-flow-interactive-handler="cancelForm" class="flow-ui-button flow-ui-destructive flow-ui-quiet">'.LCRun3::ch($cx, 'l10n', Array('flow-cancel'), 'encq').'</button>
	</div>
</form>
				...
				'.LCRun3::ifv($cx, ((is_array($in['actions']) && isset($in['actions']['lock'])) ? $in['actions']['lock'] : null), $in, function($cx, $in) {return '
					<li>
						<a class="flow-ui-button flow-ui-progressive flow-ui-quiet flow-ui-thin" 
						   ...
						   data-flow-interactive-handler="moderatePostDialog" 
						   data-role="lock">
