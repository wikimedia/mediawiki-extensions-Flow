...
$messages['it'] = array(
	...
	'flow-rev-message-reply-bundle' => '$1 {{PLURAL:$1|commento è stato aggiunto|commenti sono stati aggiunti}}.', # Fuzzy
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|ha modificato}} il titolo della discussione in [$2 $3]', # Fuzzy
...
$messages['mk'] = array(
	...
	'flow-rev-message-reply-bundle' => '{{PLURAL:$1|Додаден е еден коментар.|Додадени се $1 коментари}}.', # Fuzzy
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|го измени}} насловот на темата [$2 $3].', # Fuzzy
...
$messages['uk'] = array(
	...
	'flow-rev-message-reply-bundle' => '$1 {{PLURAL:$1|коментар|коментарі|коментарів}} було додано.', # Fuzzy
	...
	'flow-rev-message-edit-title' => '[[User:$1|$1]] {{GENDER:$1|відредагував|відредагувала}} назву теми на [$2 $3].', # Fuzzy
