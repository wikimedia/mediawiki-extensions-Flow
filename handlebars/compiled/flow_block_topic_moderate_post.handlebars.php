...
').'';},'flow_post_meta_actions' => function ($cx, $in) {return '<div class="flow-post-meta">
	...
	<span class="flow-post-timestamp">
		...
		' : '
			'.LCRun3::hbch($cx, 'ifCond', Array(Array(((isset($in['lastEditUser']['name']) && is_array($in['lastEditUser'])) ? $in['lastEditUser']['name'] : null),'!==',((isset($in['author']['name']) && is_array($in['author'])) ? $in['author']['name'] : null)),Array()), $in, function($cx, $in) {return '
