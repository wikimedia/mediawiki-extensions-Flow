...
class FlowHooks {
	...
	public static function onResourceLoaderRegisterModules( ResourceLoader &$resourceLoader ) {
		...
		if ( $wgFlowEventLogging && class_exists( 'ResourceLoaderSchemaModule' ) ) {
			...
			// Add EventLogging subscriber as dependency to Flow JS, so
			// mw.track routes to EventLogging.
			$extFlowModule['dependencies'][] = 'ext.eventLogging.subscriber';
		}

		$resourceLoader->register( 'ext.flow', $extFlowModule );
