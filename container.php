...
$c['storage.board_history'] = $c->share( function( $c ) {
	...
	$indexes = array(
		new BoardHistoryIndex( $cache, $storage, $c['repository.tree'], 'flow_revision:topic_list_history',
			array( 'topic_list_id' ),
			array(
				'limit' => 500,
				'sort' => 'rev_id',
...
$c['storage.header'] = $c->share( function( $c ) {
	...
	$indexes = array(
		...
		new BoardHistoryHeaderIndex( $cache, new BoardHistoryStorage( $c['db.factory'] ), $c['repository.tree'], 'flow_revision:topic_list_history',
			array( 'topic_list_id' ),
			array(
				'limit' => 500,
				'sort' => 'rev_id',
