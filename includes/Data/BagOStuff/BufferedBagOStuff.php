...
class BufferedBagOStuff extends HashBagOStuff {
	...
	public function add( $key, $value, $exptime = 0 ) {
		...
		if ( $this->get( $key ) === false ) {
			$this->defer( $add, func_get_args(), $key );
	...
	public function commit() {
		...
		// Everything successfully, clear local data
	...
	public function clear( $key ) {
		...
		// This method has to be public because we can't access $this in the
		// closures that will need to call this. Let's just throw an exception
		// to make sure that when someone accidentally calls this, it'll be
		// promptly noticed. Yes, I'm looking at you! Yes, you, who are reading
		// this! What else are you doing here? Don't call this! :)
		throw new FlowException( "You're not supposed to call this method - it's only for internal use!" );
	}
