( function ( $ ) {
	...
	mw.flow.Initializer.prototype.setupNewTopicWidget = function ( $form ) {
		...
		} ).once( 'save', this.refreshOnCreate ); // Refresh if board is new
	...
	mw.flow.Initializer.prototype.setupDescriptionWidget = function ( $element ) {
		...
		} ).once( 'saveContent', this.refreshOnCreate ); // Refresh if board is new
	 ...
	 */
	mw.flow.Initializer.prototype.refreshOnCreate = function () {
