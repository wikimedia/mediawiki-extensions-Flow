...
class FlowPage
  ...
  button(:delete_button, css: 'div.tipsy-inner > div.flow-tipsy-flyout > ul > li.flow-action-delete > input.flow-delete-post-link.mw-ui-button')
  a(:edit_post_icon, title: 'Edit post')
  a(:edit_title_icon, title: 'Edit title')
  div(:flow_body, class: 'flow-container')
  button(:hide_button, css: 'div.tipsy-inner > div.flow-tipsy-flyout > ul > li.flow-action-hide > input.flow-hide-post-link.mw-ui-button')
