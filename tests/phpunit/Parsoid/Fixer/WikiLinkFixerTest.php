	...
	public static function redLinkProvider() {
		return [
			[
				...
				'<a rel="mw:WikiLink" href="./Talk:Flow/Bugs" data-parsoid=\'{"stx":"simple",' .
					'"a":{"href":"./Talk:Flow/Bugs"},"sa":{"href":"Talk:Flow/Bugs"},"dsr":' .
					'[0,18,2,2]}\'>Talk:Flow/Bugs</a>',
				// expect string
			...
			[
				...
				'<a rel="mw:WikiLink" href=".//SubPage" data-parsoid=\'{"stx":"simple","a":' .
					'{"href":".//SubPage"},"sa":{"href":"/SubPage"},"dsr":[0,12,2,2]}\'>' .
					'/SubPage</a>',
				// expect string
			...
			[
				...
				'<a rel="mw:WikiLink" href="./Foo&amp;Bar" data-parsoid=\'{"stx":"simple","a":' .
					'{"href":"./Foo&amp;Bar"},"sa":{"href":"Foo&amp;Bar"},"dsr":[0,11,2,2]}\'>' .
					'Foo&amp;Bar</a>',
				// expect string
				'>Foo&amp;Bar</a>',
			],
			...
			[
				...
				'<a rel="mw:WikiLink" href="./Foo" data-parsoid=\'{"stx":"piped","a":{"href":' .
					'"./Foo"},"sa":{"href":"Foo"},"dsr":[0,19,6,2]}\'>test – test</a>',
			...
			[
				...
				'<a rel="mw:WikiLink" href="./Viquip%C3%A8dia:La_taverna/Tecnicismes/Arxius_2" ' .
					'title="Viquipdia:La taverna/Tecnicismes/Arxius 2" data-parsoid=\'{"stx":' .
					'"simple","a":{"href":"./Viquipdia:La_taverna/Tecnicismes/Arxius_2"},"sa":' .
					'{"href":"Viquipdia:La taverna/Tecnicismes/Arxius 2"},"dsr":[59,105,2,2]}\'>' .
					'Viquipdia:La taverna/Tecnicismes/Arxius 2</a>',
