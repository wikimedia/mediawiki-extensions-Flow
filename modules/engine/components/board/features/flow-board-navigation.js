...
( function ( $, mw ) {
	...
	function flowBoardLoadEventsBoardNavigation( $boardNavigation ) {
		...
		// data-flow-sort of either 'newest' or 'recent'. Typically this is the anchor
		...
		// This is semi-duplicated work, but in instances where the above doesn't load anything
		// it wont update the scroll position, so we need that too.
		$
	}
