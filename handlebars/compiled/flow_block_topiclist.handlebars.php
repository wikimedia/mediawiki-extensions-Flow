...
';}).'';},'flow_load_more' => function ($cx, $in) {return ''.((LCRun3::ifvar($cx, ((isset($in['loadMoreObject']) && is_array($in)) ? $in['loadMoreObject'] : null))) ? '
	<div class="flow-load-more">
		...
		<a data-flow-interactive-handler="apiRequest"
		   ...
		   class="mw-ui-button mw-ui-progressive flow-load-interactive flow-ui-fallback-elementx"><span class="wikiglyph wikiglyph-article"></span> '.LCRun3::ch($cx, 'l10n', Array(Array('flow-load-more'),Array()), 'encq').'</a>
	</div>
' : '
