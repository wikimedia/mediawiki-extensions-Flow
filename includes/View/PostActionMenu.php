...
class PostActionMenu {
	...
	public function __construct( UrlGenerator $urlGenerator, PostActions $security, Block $block, PostRevision $post, $editToken ) {
	...
	public function isAllowedAny( $action /* [, $action2 [, ... ]] */ ) {
		...
		return call_user_func_array( array( $this->security, 'isAllowedAny' ), $arguments );
	}
