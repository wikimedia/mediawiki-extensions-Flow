...
abstract class RevisionStorage implements WritableObjectStorage {
	...
	public function findMulti( array $queries, array $options = array() ) {
		...
		if ( $this->externalStore ) {
			// TODO: This should only merge rows with the 'external' flag set
			// Also, perhaps it doesnt need to be guarded with $this->externalStore? because
			// the url's contain all necessary info and flags tell us when we need it.
