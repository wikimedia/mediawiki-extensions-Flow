...
class HeaderBlock extends AbstractBlock {
	...
	/**
	 * @var Header The current header model
	 */
	protected $header;

	/**
	 * @var Header The initially loaded header model
	 */
	...
	public function init( $action, $user ) {
		...
		if ( $found ) {
			// When $this->header is replaced with a version generated from user submitted
			// content, $this->origHeader still points at the initially loaded revision.
