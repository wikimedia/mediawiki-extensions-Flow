( function ( mw, OO, ve ) {
	...
	OO.inheritClass( mw.flow.ve.ui.SwitchEditorTool, ve.ui.InspectorTool );
	...
	//mw.flow.ve.ui.SwitchEditorTool.static.template = mw.flow.ve.ui.SwitchEditor.static.template;
