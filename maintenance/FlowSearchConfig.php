 ...
 *
 * @ingroup Maintenance
 * @phan-file-supress PhanUndeclaredClassMethod,PhanTypeMismatchArgument,PhanUndeclaredStaticMethod
 * @phan-file-supress PhanParamTooFew,PhanUndeclaredMethod This script is outdated, T227563
 */
